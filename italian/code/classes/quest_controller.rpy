translate italian strings:
    ...
    new "Devi progredire in {storyline_name} "

    # game/code/classes/quest_controller.rpy:217
    old "You are currently in a scene"
    new "Sei attualmente in una scena"
...
translate italian strings:
    ...
    new "Devi progredire in [storyline_names!t]"

translate italian strings:

    # game/code/classes/quest_controller.rpy:156
    old "You need to progress [storyline_name!t]"
    new "Devi progredire in [storyline_name!t]"

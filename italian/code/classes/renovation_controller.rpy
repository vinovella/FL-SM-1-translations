translate italian strings:
    ...
    # game/code/classes/renovation_controller.rpy:97
    old "Done today"
    new "Fatto oggi"

    # game/code/classes/renovation_controller.rpy:99
    old "No energy"
    new "Nessuna energia"

    # game/code/classes/renovation_controller.rpy:104
    old "You need to be at the Studio to work on renovation"
    new "Devi essere allo Studio per lavorare alla ristrutturazione"

    # game/code/classes/renovation_controller.rpy:105
    old "Work on renovation"
    new "Lavora alla ristrutturazione"

    # game/code/classes/renovation_controller.rpy:132
    old "Renovation upgrade"
    new "Aggiornamento ristrutturazione"
...
translate italian strings:
    ...
    new "Progresso della ristrutturazione aumentato del [progress]%"
    ...
    new "Il progresso della ristrutturazione è oltre il 50%.\nNon puoi più ricevere aiuto da [character!t]."
    ...
    new "[character!t] può assistere con la ristrutturazione [before_after!t] del completamento.\nParla con [character!t] per procedere."

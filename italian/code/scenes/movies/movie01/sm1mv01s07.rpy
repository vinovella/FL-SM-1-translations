...
translate italian sm1mv01s07_2e0f1463:

    # sy "I figured out how we are going to fix the problem."
    sy "Ho capito come risolveremo il problema."
...
translate italian sm1mv01s07_7af5ed97:
    ...
    sy "*sospira* Dai, concentrati sul gioco."
...
translate italian sm1mv01s07_636fd15e:
    ...
    mc "Abbiamo aggirato le regole prima."

# game/code/scenes/movies/movie01/sm1mv01s07.rpy:42
translate italian sm1mv01s07_8cce3097:

    # sy "Do you want sand mites?"
    sy "Vuoi gli acari della sabbia?"
...
translate italian sm1mv01s07_e1a6e5f4:
...
translate italian sm1mv01s07_4c79aeb3:
    ...
    sy "Il posto è a pochi passi dalla Palace Beach."

# game/code/scenes/movies/movie01/sm1mv01s07.rpy:68
translate italian sm1mv01s07_1d6a2b5a:

    # sy "The good news is that the water is cold right now. Which means..."
    sy "La buona notizia è che l'acqua è fredda in questo momento. Il che significa..."
...
translate italian sm1mv01s07_4d834828:
    ...
    sy "La Grotta Carcio. Il posto perfetto per la nostra scena del tesoro sepolto."

# game/code/scenes/movies/movie01/sm1mv01s07.rpy:85
translate italian sm1mv01s07_b50da79f:

    # mc "I'm speechless."
    mc "Sono senza parole."

# game/code/scenes/movies/movie01/sm1mv01s07.rpy:87
translate italian sm1mv01s07_f9919e40:

    # sy "Am I good, or am I good?"
    sy "Sono brava, o sono brava?"
...
translate italian sm1mv01s07_6d783f27:
    ...
    mc "Ma se facciamo questo, dovremo lasciare la città per un po'."
...
translate italian sm1mv01s07_495a8ab5:

    # sy "A little mini vacation."
    sy "Una piccola mini vacanza."
...
translate italian sm1mv01s07_c5fb4c04:
    ...
    sy "Fantastico.{w} Viaggio su strada!"

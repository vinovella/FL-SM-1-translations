...
translate italian sm1ms023_02_b9b9d47c:
    ...
    sy "Niente è {i}sbagliato{/i}, ma c'è ancora del lavoro da fare."
...
translate italian sm1ms023_02_e82478bf:
    ...
    sy "Quello che sto cercando di dire è che alcuni rumori sono più forti di altri."
...
translate italian sm1ms023_02_03c2f1c8:
    ...
    sy "E dato che non abbiamo un mixer audio, abbiamo alcuni strani problemi audio."
...
translate italian sm1ms023_02_073f2cb7:
    ...
    sy "Quindi in questo momento il nostro unico audio proviene dalla videocamera di Kanya."
...
translate italian sm1ms023_02_35ca6c0c:
    ...
    sy "Quindi quando Kanya si avvicina o si allontana da noi, il livello audio sale o scende. Quindi a volte è più forte, a volte è più silenzioso."
...
translate italian sm1ms023_02_2eda3872:
    ...
    sy "E poi a volte, diventiamo più forti o più silenziosi."
...
translate italian sm1ms023_02_3d4ef587:
    ...
    sy "Ok, io. Divento più forte, testa di cazzo."
...
translate italian sm1ms023_02_a04c063c:
    ...
    sy "Perché mi stai scopando con il tuo grande cazzo e mi fai gemere il tuo nome."
...
translate italian sm1ms023_02_b1dbc534:
    ...
    sy "Quindi, ad un certo punto, vorremo trovare qualcuno che installi dei microfoni o qualcosa del genere così possiamo registrare un audio più pulito."

# game/code/scenes/main_story/sm1ms023_02.rpy:106
translate italian sm1ms023_02_b3e27bcb:

    # mc "That's probably a good idea."
    mc "Probabilmente è una buona idea."
...
translate italian sm1ms023_02_9003821c:
    ...
    mc "Conosciamo anche solo qualcuno che sappia come gestire l'audio?"
...
translate italian sm1ms023_02_c3e05d91:
    ...
    sy "Quindi tu ti occupi del reclutamento."
...
translate italian sm1ms023_02_47b9ed68:
    ...
    sy "Il che significa che dovrai trovarci una persona per l'audio."
...
translate italian sm1ms023_02_ad816699:
    ...
    sy "Perché hai la migliore maledetta sorella del mondo."
...
translate italian sm1ms023_02_459b7c62:
    ...
    sy "Perché hai la migliore maledetta amica del mondo."
...
translate italian sm1ms023_02_60639e3b:
    ...
    mc "Mi inchino davanti alla tua magnificenza e splendore, Stacy."
...
translate italian sm1ms023_02_6abfb4c7:
    ...
    sy "E spero di ricevere una ricompensa per aver fatto un così buon lavoro."
...
translate italian sm1ms023_02_0dca1676:
    ...
    mc "Penso che tu debba finire il video e mandarlo al cliente."
...
translate italian sm1ms023_02_acd8e3d0:
    ...
    sy "Niente sulla verde terra di Dio potrebbe impedirmi di masturbarmi con questo filmato così hot."

# game/code/scenes/main_story/sm1ms023_02.rpy:197
translate italian sm1ms023_02_0b799436:

    # mct "God, Stacy is wild."
    mct "Dio, Stacy è selvaggia."

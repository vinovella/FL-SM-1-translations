...
translate italian sm1cs_my002i_ad770c80:

    # sy "How'd your date with Mom go!"
    sy "Com'è andata l'appuntamento con la mamma!"

# game/code/scenes/character_scenes/my/sm1cs-my002i.rpy:9
translate italian sm1cs_my002i_5dedad5a:

    # sy "How'd your date with Melony go!"
    sy "Com'è andata l'appuntamento con Melony!"

# game/code/scenes/character_scenes/my/sm1cs-my002i.rpy:11
translate italian sm1cs_my002i_ebe74db8:

    # mc "I think it went well! Had some good bants, and, you know, fancy food, and..."
    mc "Penso sia andata bene! Abbiamo chiacchierato bene, e, sai, cibo raffinato, e..."

# game/code/scenes/character_scenes/my/sm1cs-my002i.rpy:15
translate italian sm1cs_my002i_dd424c8d:

    # sy "Bants, really? That's the word you want to use? {i}Bants{/i}?"
    sy "Chiacchierato, davvero? È questa la parola che vuoi usare? {i}Chiacchierato{/i}?"

# game/code/scenes/character_scenes/my/sm1cs-my002i.rpy:17
translate italian sm1cs_my002i_7c8bee12:

    # mc "That's what I said."
    mc "È quello che ho detto."

# game/code/scenes/character_scenes/my/sm1cs-my002i.rpy:18
translate italian sm1cs_my002i_368a3c1b:

    # sy "Ugh, I need more coffee for this..."
    sy "Ugh, mi serve più caffè per questo..."

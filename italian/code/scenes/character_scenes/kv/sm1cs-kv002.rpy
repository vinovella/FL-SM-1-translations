...
translate italian sm1cs_kv002_2ea7f9eb:
    ...
    kv "Ciao [mcname]. Haha. Hai un talento per arrivare proprio alla fine dei miei servizi fotografici."
...
translate italian sm1cs_kv002_360183ad:
    ...
    kv "Che mi avviserai la prossima volta così possiamo semplicemente uscire insieme?"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:35
translate italian sm1cs_kv002_2b43865a:

    # mc "I promise to next time."
    mc "Prometto che lo farò la prossima volta."
...
translate italian sm1cs_kv002_d6c3b738:
    ...
    kv "Bene. Prendi una sedia mentre finisco questo."
...
translate italian sm1cs_kv002_439f1141:
    ...
    kv "Sempre che vada bene per te."
...
translate italian sm1cs_kv002_5667f407:
    ...
    "Modella" "Certo, non mi importa affatto. Va benissimo. Uh huh."
...
translate italian sm1cs_kv002_43b6c7d3:
    ...
    mct "Perché mi sembra familiare?"
...
translate italian sm1cs_kv002_83efe65b:
    ...
    kv "Hai imparato qualcosa sulla fotografia dall'ultima volta che ci siamo visti?"
...
translate italian sm1cs_kv002_23985d8c:
    ...
    mc "Penso di sì. Non sono sicuro di quanto mi sia rimasto, ma ho letto il libro che mi hai consigliato!"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:64
translate italian sm1cs_kv002_60fe787f:

    # kv "Great, what's an ISO?"
    kv "Ottimo, cos'è un ISO?"
...
translate italian sm1cs_kv002_0cd4827f:
    ...
    mc "Aspetta, non sapevo ci fosse un test!"
...
translate italian sm1cs_kv002_7102a16d:
    ...
    kv "L'arte è tutta una sofferenza. Ora dai, cos'è un ISO?"
...
translate italian sm1cs_kv002_eb75f576:
    ...
    mc "La sensibilità del sensore alla luce."
...
translate italian sm1cs_kv002_db45f824:
    ...
    kv "Come determini la profondità di campo?"
...
translate italian sm1cs_kv002_4601535a:
    ...
    kv "Ultima domanda; quando inizi a vedere la distorsione dell'obiettivo dalla lunghezza focale, spesso chiamato 'effetto fishbowl'?"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:96
translate italian sm1cs_kv002_f8c88d48:

    # mc "Under 35mm, right?"
    mc "Sotto i 35mm, giusto?"
...
translate italian sm1cs_kv002_612be1cd:
    ...
    kv "Esatto! Una volta sotto i 35mm inizi a vedere la distorsione negli angoli."
...
translate italian sm1cs_kv002_d4be0d5e:
    ...
    kv "Voglio dire, hai sicuramente letto il libro, il che è fantastico."
...
translate italian sm1cs_kv002_bec64362:
    ...
    kv "Ma mi è venuta un'idea divertente. Perché non provi a prendere un po' di quella teoria e metterla in pratica?"
...
translate italian sm1cs_kv002_9ae2eac4:
    ...
    kv "Beh, ho tutte le foto di cui ho bisogno, e mi sento soddisfatta. Quindi se va bene per lei, potrebbe fare un po' di modella per noi e tu puoi provare a metterti dietro la macchina fotografica."
...
translate italian sm1cs_kv002_3cef9b83:
    ...
    "Modella" "Non pensavo che oggi avrei aiutato un fotografo alle prime armi."
...
translate italian sm1cs_kv002_d8872958:
    ...
    kv "Sono foto gratis! Inoltre, dopo averle viste capirai perché faccio pagare quello che faccio pagare."
...
translate italian sm1cs_kv002_c85124d1:
    ...
    "Modella" "Eh, giusto. Certo, perché no. È meglio che tornare al mio lavoro di merda."
...
translate italian sm1cs_kv002_e7b9b1a8:
    ...
    kv "Perfetto. [mcname], vieni a prendere la macchina fotografica."
...
translate italian sm1cs_kv002_52ed4e78:
    ...
    kv "Okay, questo è il pulsante di scatto dell'otturatore. Sai, per scattare le foto."
...
translate italian sm1cs_kv002_64bd860c:
    ...
    kv "Così controlli la velocità dell'otturatore. Quello è per il diaframma."
...
translate italian sm1cs_kv002_23be19a5:
    ...
    kv "Ma tutto dovrebbe essere già impostato per te. Devi solo puntare e scattare!"
...
translate italian sm1cs_kv002_af1e0134:
    ...
    kv "Ma non limitarti a puntare e scattare. Guarda attraverso il mirino e componi le tue inquadrature."
...
translate italian sm1cs_kv002_524cc5f7:
    ...
    kv "Vuole che tu faccia un primo piano."
...
translate italian sm1cs_kv002_01496ef0:
    ...
    kv "No, ma in futuro potresti doverlo fare. Ma possiamo saltarlo oggi."
...
translate italian sm1cs_kv002_712ede90:
    ...
    "Modella" "Ottimo, cosa ne pensi delle foto?"
...
translate italian sm1cs_kv002_3ef07597:
    ...
    "Modella" "Fantastico. Devo andare a lavorare ora. Ci si vede in giro!"
...
translate italian sm1cs_kv002_6af1c1b3:
    ...
    mct "Giuro che la conosco da qualche parte..."
...
translate italian sm1cs_kv002_b7a6fcb7:
    ...
    kv "Non male, per niente male. Hai ancora un po' da imparare, ma sembra che tu abbia occhio per la fotografia."
...
translate italian sm1cs_kv002_3131d4a1:
    ...
    kv "Sì! Con un po' di allenamento potresti diventare un fotografo davvero bravo, penso."
...
translate italian sm1cs_kv002_2f41dc06:
    ...
    mc "Se posso scattare foto di ragazze sexy nude tutto il giorno, ci sto!"
...
translate italian sm1cs_kv002_22a6edaf:
    ...
    kv "Non sono sempre persone sexy nude. A volte sono matrimoni e bar mitzvah."
...
translate italian sm1cs_kv002_c8d05e4c:
    ...
    mc "Oh, sembra molto meno divertente."
...
translate italian sm1cs_kv002_652d234c:
    ...
    kv "Ma mi paga l'affitto, quindi non mi lamento."
...
translate italian sm1cs_kv002_d5f01285:
    ...
    mc "Preferirei un bar mitzvah a un cubicolo qualsiasi giorno."
...
translate italian sm1cs_kv002_9304d30e:
    ...
    kv "È esattamente come mi sento io!"
...
translate italian sm1cs_kv002_96ae6470:
    ...
    mc "Allora perché fai le cose da nudo?"
...
translate italian sm1cs_kv002_fe965f78:
    ...
    kv "Paga un po'. Ed è moooolto più divertente delle altre cose."
...
translate italian sm1cs_kv002_94c69e23:
    ...
    mct "Merda, se è come oggi ci credo."
...
translate italian sm1cs_kv002_2cd8e858:
    ...
    kv "Beh, hai sicuramente un buon occhio. Non è Guy Bourdin, ma c'è un po' di talento in queste foto."
...
translate italian sm1cs_kv002_97a64fa5:
    ...
    kv "Forse hai quello che serve per aprire uno studio porno."
...
translate italian sm1cs_kv002_f331b902:
    ...
    kv "Penso che dovrei passare a dare un'occhiata."
...
translate italian sm1cs_kv002_17239b3c:
    ...
    mc "È probabilmente la mia migliore qualità, se devo essere onesto."
...
translate italian sm1cs_kv002_f156bf59:
    ...
    kv "Non so se sia la tua {i}migliore{/i} qualità, ma è tra le prime."
...
translate italian sm1cs_kv002_3ee97022:
    ...
    kv "Fammi sapere quando posso passare."
...
translate italian sm1cs_kv002_1559a009:
    ...
    mc "Assolutamente! Ti chiamerò. Anzi..."
...
translate italian sm1cs_kv002_87442d6e:
    ...
    mc "Questo è il mio indirizzo. Mandami un messaggio quando vuoi passare."
...
translate italian sm1cs_kv002_db30c400:
    ...
    kv "Ma devo proprio andare. Ho anche una sessione a casa da fare."
...
translate italian sm1cs_kv002_20a4d082:
    ...
    kv "Non preoccuparti. È un cliente di lunga data e... È un servizio un po' insolito. Ma dovresti chiamarmi presto!"
...
translate italian strings:
    ...
    new "Devi annoiarti a quelli"

    # game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:205
    old "Beats sitting in an office"
    new "Meglio che stare seduto in un ufficio"

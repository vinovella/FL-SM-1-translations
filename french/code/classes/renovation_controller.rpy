translate french strings:
    ...
    new "Va d'abord sur un de tes lieux de travail avec Stacy et Melony"

    # game/code/classes/renovation_controller.rpy:95
    old "Talk with Stacy to install the stairs"
    new "Parle avec Stacy pour installer les escaliers"

    # game/code/classes/renovation_controller.rpy:97
    old "Done today"
    new "Déjà fait aujourd'hui"

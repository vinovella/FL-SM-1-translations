translate french strings:
    ...
    new "Salut maman, je me demandais… ça te dirait qu’on dîne ensemble ?"

    # game/code/data/chat/chat_my.rpy:53
    old "Hey Melony, I was wondering if you would want to get dinner together?"
    new "Salut Melony, je me demandais si tu voudrais aller dîner avec moi ?"

    # game/code/data/chat/chat_my.rpy:53
    old "That sounds wonderful, [mcname!i]! Where would you like to go?"
    new "Ça me ferait très plaisir, [mcname!i] ! Tu veux aller où ?"

    # game/code/data/chat/chat_my.rpy:53
    old "Put on something nice, I'll pick you up in an hour!"
    new "Mets quelque chose de joli, je passe te chercher dans une heure !"

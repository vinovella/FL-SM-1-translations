translate french strings:
    ...
    new "Attends le prochain début de matinée pour parler du film avec Stacy"
    ...
    new "Continue d'investir dans le budget costumes pour préparer les tenues"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk with Stacy to buy costumes"
    new "Parle avec Stacy pour acheter des costumes"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk with Stacy to hire an actress"
    new "Parle avec Stacy pour engager une actrice"

    # game/code/data/quests/quests_movies.rpy:3
    old "Add money to buy props and energy to build them"
    new "Ajoute de l'argent pour acheter les accessoires et de l'énergie pour les fabriquer"

    # game/code/data/quests/quests_movies.rpy:3
    old "Add money to buy props"
    new "Ajoute de l'argent pour acheter les accessoires"

    # game/code/data/quests/quests_movies.rpy:3
    old "Add energy to build the props"
    new "Ajoute de l'énergie pour fabriquer les accessoires"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Stacy in the morning to start filming the movie"
    new "Parle avec Stacy le matin pour commencer à filmer le film"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk with Taisia to start filming the next scene"
    new "Parle avec Taisia pour commencer à filmer la prochaine scène"
    ...
    new "Attends le début de matinée pour parler du film de science-fiction avec Stacy"

    # game/code/data/quests/quests_movies.rpy:3
    old "Recruit Lyssa or Min as the actress for the Sci-Fi movie (you can only recruit one)"
    new "Recrute Lyssa ou Min comme actrice pour le film de science-fiction (tu ne peux en choisir qu’une)"

    # game/code/data/quests/quests_movies.rpy:3
    old "Recruit Nari as the lead actress for the Sci-Fi movie"
    new "Recrute Nari comme actrice principale du film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Stacy about Sci-Fi movie props"
    new "Parle avec Stacy des accessoires du film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Stacy about building the set"
    new "Parle avec Stacy de la construction du décor"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Kanya to continue building the set in Photo Dojo"
    new "Parle avec Kanya pour continuer à construire le décor au Photo Dojo"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Stacy in the afternoon about the next step for the Sci-Fi movie"
    new "Parle avec Stacy l'après-midi pour la prochaine étape du film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Stacy to prepare for filming the Sci-Fi movie"
    new "Parle avec Stacy pour préparer le tournage du film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Add money to pay actresses and energy to prepare outfits"
    new "Ajoute de l'argent pour payer les actrices et de l'énergie pour préparer les tenues"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Stacy in the evening to start filming the Sci-Fi movie"
    new "Parle avec Stacy le soir pour commencer le tournage du film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk with Stacy to film the next Sci-Fi movie scene"
    new "Parle avec Stacy pour filmer la prochaine scène du film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk about going to the spa"
    new "Parler d'aller au spa"

    # game/code/data/quests/quests_movies.rpy:3
    old "Min wants to talk to you about Nari"
    new "Min veut te parler à propos de Nari"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Nari about going to the spa with Lyssa"
    new "Parle à Nari d'aller au spa avec Lyssa"

    # game/code/data/quests/quests_movies.rpy:3
    old "Have fun at the spa"
    new "Amuse-toi au spa"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Nari about going to the spa with Min"
    new "Parle à Nari d'aller au spa avec Min"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Lyssa about going to the spa with Nari"
    new "Parle à Lyssa d'aller au spa avec Nari"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk with Stacy about big scenes in the Sci-Fi movie"
    new "Parle avec Stacy des grandes scènes du film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Add money for CGI"
    new "Ajoute de l'argent pour les effets spéciaux (CGI)"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk to Stacy at the studio in the early morning"
    new "Parle avec Stacy au studio en début de matinée"

    # game/code/data/quests/quests_movies.rpy:3
    old "Talk with Stacy to film the final scene of the Sci-Fi movie"
    new "Parle avec Stacy pour filmer la scène finale du film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Add energy to edit the Sci-Fi movie"
    new "Ajoute de l'énergie pour monter le film de science-fiction"

    # game/code/data/quests/quests_movies.rpy:3
    old "Tell Stacy that you are done editing the Sci-Fi movie in the afternoon"
    new "Dis à Stacy que tu as terminé le montage du film de science-fiction dans l'après-midi"

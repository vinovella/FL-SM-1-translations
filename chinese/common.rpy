translate chinese strings:
    ...
    new "本菜单上的选项旨在提升游戏可访问性，不一定适用于所有游戏。某些选项组合可能会导致游戏无法运行。这不是游戏或引擎的问题。为了获得最佳效果，当改变字体时，请尽量保持文本大小与最初相一致。"
    ...
    new "该程序为获得多项许可证的免费软件，包括 MIT许可证和 GNU通用公共许可证。如需完整的软件列表以及软件的完整源代码，请访问{a=https://www.renpy.org/l/license}here{/a}."
    ...
    new "自动语音会读\"[renpy.display.tts.last]\"，按'alt+shift+V'键禁用。"
    ...
    new "\n{color=#cfc}✔ 预测图象(好){/color}\n{color=#fcc}✘ 不可预测的图像(坏){/color}\n{color=#fff}拖动可移动。{/color}"
    ...
    new "此电脑显示图像有误: [problem]。"

    # renpy/common/00gltest.rpy:255
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "此电脑的图形驱动程序可能已过期或无法正常运行。这可能会导致图像加载缓慢或者失败。"

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "此{a=edit:1:log.txt}log.txt{/a}文件中可能包含一些信息，可以帮助您确定计算机的问题。"
    ...
    new "将traceback.txt文件作为BBcode复制到剪贴板，用于 https://lemmasoft.renai.us/ 等论坛。"
    ...
    new "将traceback.txt文件作为Discord的Markdown，复制到剪贴板。"
    ...
    new "从磁盘重新加载游戏，并在可能的情况下保存和恢复游戏状态。"
...
translate chinese strings:
    ...
    new "单击设置转换，右击添加至转换列表。"

    # renpy/common/00director.rpy:1789
    old "Click to set, right click to add to behind list."
    new "单击进行设置，右击添加至后置列表。"

    # renpy/common/00gui.rpy:456
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "此保存文件创建于另一个设备。恶意构建的保存文件可能会损害您的计算机。您信任此存档的创建者以及所有可能更改文件的人吗？"

    # renpy/common/00gui.rpy:457
    old "Do you trust the device the save was created on? You should only choose yes if you are the device's sole user."
    new "您是否信任创建此保存文件的设备？只有当您是该设备的唯一用户时，才应选择“是”。"
    ...
    new "Ren'Py 同步服务器没有此同步的副本。同步ID可能无效，或可能已超时。"
    ...
    new "此操作将把您保存的文件上传到{a=https://sync.renpy.org}Ren'Py同步服务器{/a}.\n您想继续吗？"
    ...
    new "此操作将联系{a=https://sync.renpy.org}Ren'Py同步服务器{/a}."

translate magyar strings:
    ...
    # game/code/classes/movie_controllers.rpy:125
    old "You have filled the budget already"
    new "You have filled the budget already"

    # game/code/classes/movie_controllers.rpy:127

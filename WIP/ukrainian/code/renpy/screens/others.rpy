translate ukrainian strings:
    ...
    new "Ми збираємо лише анонімні дані, щоб краще зрозуміти, які шляхи, персонажі, сцени та фетиші є найпопулярнішими, а також визначити області для покращення."

    # game/code/renpy/screens/others.rpy:35
    old "NO PERSONAL INFORMATION IS COLLECTED."
    new "ОСОБИСТА ІНФОРМАЦІЯ НЕ ЗБИРАЄТЬСЯ."

    # game/code/renpy/screens/others.rpy:36
    old "Would you like to enable this data collection?"
    new "Бажаєте увімкнути збір цих даних?"

    # game/code/renpy/screens/others.rpy:118
    old "Please enter your name here!"
    new "Будь ласка, введіть своє ім'я тут!"

    # game/code/renpy/screens/others.rpy:126
    old "{u}DONE{/u}"
    new "{u}ГОТОВО{/u}"

    # game/code/renpy/screens/others.rpy:164
    old "Please enter your Local IP number:"
    new "Будь ласка, введіть свій локальний IP-номер:"

    # game/code/renpy/screens/others.rpy:167
    old "Please enter your HTTP Port number:"
    new "Будь ласка, введіть номер HTTP-порту:"

    # game/code/renpy/screens/others.rpy:170
    old "How do you want to name your save?"
    new "Як ви хочете назвати своє збереження?"

    # game/code/renpy/screens/others.rpy:173
    old "How do you want to name your Season 2 save?"
    new "Як ви хочете назвати своє збереження Сезону 2?"

    # game/code/renpy/screens/others.rpy:203
    old "Save"
    new "Зберегти"

    # game/code/renpy/screens/others.rpy:12
    old "If the recent minigames/puzzles feel a bit tricky, that's totally okay."
    new "Якщо останні міні-ігри/головоломки здаються трохи складними, це цілком нормально."
    ...
    new "Ви можете вимкнути міні-ігри/головоломки для цього проходження та продовжити історію без них."
    ...
    new "Після вимкнення міні-ігри не можна буде знову увімкнути для цього проходження, і досягнення міні-ігор не будуть отримані."

    # game/code/renpy/screens/others.rpy:16
    old "Disable Minigames"
    new "Вимкнути міні-ігри"

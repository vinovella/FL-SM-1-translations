translate turkish strings:
    ...
    new "Şimdi VN Moduna geçeceksiniz\nİlerlemeniz aktarılacaktır\n\nBu önerilmez ve bunu yapmak hatalara ve aksaklıklara neden olabilir"
    ...
    new "Bir kez geçiş yaptığınızda, geri dönemezsiniz\n\nEski kaydınızı yükleyerek normal şekilde oynamaya devam edebilirsiniz"

    # game/code/renpy/labels/vn_mode.rpy:20
    old "It's recomended to start a new game in VN Mode\n\nPlease procced at your own risk"
    new "VN Modunda yeni bir oyuna başlamanız önerilir\n\nLütfen kendi sorumluluğunuzda devam edin"

    # game/code/renpy/labels/vn_mode.rpy:35
    old "You have finished all the content avialable in this release"
    new "Bu sürümde bulunan tüm içeriği tamamladınız."

    # game/code/renpy/labels/vn_mode.rpy:39
    old "Please save your game so you can resume playing from here in the next release"
    new "Lütfen oyununuzu kaydedin, böylece bir sonraki sürümde buradan oynamaya devam edebilirsiniz."

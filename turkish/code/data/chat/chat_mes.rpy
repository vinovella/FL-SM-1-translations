translate turkish strings:
    ...
    new "Merhaba Min. Neler oluyor?"

    # game/code/data/chat/chat_mes.rpy:3
    old "Classes, studying, sleep 😓"
    new "Dersler, çalışma, uyku 😓"

    # game/code/data/chat/chat_mes.rpy:3
    old "Starting to wish I never came back here 😕"
    new "Buraya hiç dönmemiş olmayı dilemeye başladım 😕"

    # game/code/data/chat/chat_mes.rpy:3
    old "It's going to get better. I just know it."
    new "Her şey daha iyi olacak. Bunu biliyorum."

    # game/code/data/chat/chat_mes.rpy:3
    old "How can I help you, [mcname!i]?"
    new "Size nasıl yardımcı olabilirim, [mcname!i]?"

    # game/code/data/chat/chat_mes.rpy:3
    old "I want to invite you to check out the studio 😊"
    new "Sizi stüdyoya göz atmaya davet etmek istiyorum 😊"

    # game/code/data/chat/chat_mes.rpy:3
    old "I would, but I should focus."
    new "İsterdim ama odaklanmalıyım."

    # game/code/data/chat/chat_mes.rpy:3
    old "Come on. You're working yourself too hard."
    new "Hadi ama. Kendini çok zorluyorsun."
    ...
    new "Al bakalım. Güven bana. Burayı seveceksin."

    # game/code/data/chat/chat_mes.rpy:58
    old "Hey. Want to go for a drink?"
    new "Hey. Bir şeyler içmek ister misin?"
    ...
    new "Tabii. Olay nedir?"

    # game/code/data/chat/chat_mes.rpy:58
    old "Nothing special. Call it a mind-break date 😇"
    new "Özel bir şey değil. Buna bir zihin kırma randevusu diyelim 😇"

    # game/code/data/chat/chat_mes.rpy:58
    old "Oh. I like the sound of that 😀"
    new "Oh. Kulağa hoş geliyor 😀"

    # game/code/data/chat/chat_mes.rpy:58
    old "Don't be strange. I didn't mean a \"date\" date."
    new "Garip davranma. \“Randevu\” demek istemedim."

...
translate turkish sm1cs_ag001_cdbd2ad8:
    ...
    mc "Merhaba Anna. Bu hafta için planlanan üçüncü bileti yaptım."
...
translate turkish sm1cs_ag001_c4076054:
    ...
    ag "Harika. Yani ödevlerinden keyif alıyor musun?"
...
translate turkish sm1cs_ag001_70f9515e:
    ...
    mc "Fena değil. API kodlamada oldukça iyi oldum."
...
translate turkish sm1cs_ag001_3de6ea46:
    ...
    ag "Bu harika. Genişledikçe ve yeni müşteriler aldıkça, protoss'un pilonlara ihtiyacı olduğu gibi biz de bu modüllere ihtiyaç duyacağız."
...
translate turkish sm1cs_ag001_68bb389b:
    ...
    ag "Öhö. Sadece büyüdükçe platformumuzu güzel ve istikrarlı tutabileceğimizi kastediyorum."
...
translate turkish sm1cs_ag001_9f4eb09b:
    ...
    mc "Haha. Kodun bize zerg saldırısı yapması durumunda kullanmak üzere birkaç fanatiği hazırda tutmamız gerekiyor."

# game/code/scenes/it_office/ag/sm1cs-ag001.rpy:43
translate turkish sm1cs_ag001_c00d136c:

    # mc "But today we're in good shape."
    mc "Ama bugün iyi durumdayız."
...
translate turkish sm1cs_ag001_f44071aa:
    ...
    ag "Eğer bu işler sizin için çok kolaysa, bir adım öteye geçebiliriz."
...
translate turkish sm1cs_ag001_28431aec:
    ...
    ag "Eğer bunu başarabileceğinizi düşünüyorsanız, analitikleri uygulayabileceğiniz daha zor veritabanları gönderebiliriz."
...
translate turkish sm1cs_ag001_199893fb:
    ...
    ag "Bu, temel ödevlerinizi daha zor hale getirecek, ancak bunları doğru bir şekilde yaparsanız daha iyi bir maaş almanız anlamına da gelecek."

# game/code/scenes/it_office/ag/sm1cs-ag001.rpy:58
translate turkish sm1cs_ag001_6dd576c7:

    # mc "Cool. How would that work?"
    mc "Harika. Bu nasıl işe yarar?"
...
translate turkish sm1cs_ag001_5ea388c9:
    ...
    ag "Sadece gelip bana haber vermeniz yeterli."
...
translate turkish sm1cs_ag001_f527ee85:
    ...
    ag "Tamam. Fikrini değiştirirsen bana haber ver."
...
translate turkish sm1cs_ag001_68642bbf:
    ...
    ag "Burada bir süre kaldınız, bu yüzden ekip lideriniz olarak birkaç sorum olacak ve güzelce yerleştiğinizden emin olmak istiyorum."
...
translate turkish sm1cs_ag001_b248711a:
    ...
    ag "Megan. [mcname], Megan'la tanıştın mı?"
...
translate turkish sm1cs_ag001_0047f6c8:
    ...
    ag "Harika biri. Aslında Kalite Güvence ekibimizin sorumlusu. Megan dağıtıma hazır olduğumuzda hiçbir kötü şeyin kalmadığından emin oluyor."
...
translate turkish sm1cs_ag001_2769889a:
    ...
    ag "Birazdan gelip bakacağım, Megan. Şu anda biraz meşgulüm."
...
translate turkish sm1cs_ag001_980c0edc:
    ...
    mj "Doğru. Jayden'a da aynısını söyledim. Kümeyi iki katına çıkarmamız gerektiğini düşünüyor ve-"
...
translate turkish sm1cs_ag001_d4428722:
    ...
    ag "[mcname], üzgünüm, tüm yığını yakmadan önce bir deliyi durdurmam gerek. Megan, benimle."
...
translate turkish sm1cs_ag001_be37cdda:
    ...
    mc "Sanırım burada bekleyeceğim."
...
translate turkish sm1cs_ag001_0e5cb48a:
    ...
    mct "Bu sadece işin bir parçası. Acele edin ve bekleyin."
...
translate turkish sm1cs_ag001_88ee9a77:
    ...
    mct "Modern Gaming'in hala kağıt kopyalar ürettiğini düşünmüyordum. Ortaokuldan beri bunlardan birini okumadım."
...
translate turkish sm1cs_ag001_f81140aa:
    ...
    mct "Harika. Call to Duty: Sud's Revenge çıkıyor."
...
translate turkish sm1cs_ag001_d79237a4:
    ...
    mct "Ben orijinallerini daha çok seviyorum, ancak bu yeni sürümde çok daha iyi çok oyunculu modlar var."
...
translate turkish sm1cs_ag001_823a017d:
    ...
    mct "Bir tür oyuncu dergisine benziyor."
...
translate turkish sm1cs_ag001_83601e95:
    ...
    mct "Ana makale Call to Duty: Sud's Revenge adlı bir oyunla ilgili."
...
translate turkish sm1cs_ag001_0791f86f:
    ...
    am "Ne yapıyorsun sen Anna'nın masasının yanında gizlice dolaşıp, sapık?"
...
translate turkish sm1cs_ag001_394f3a9f:
    ...
    mc "Hiçbir şey. Anna burada beklememi söyledi. Bir çeşit toplantı."
...
translate turkish sm1cs_ag001_51d4e8f3:
    ...
    am "Kaybeden olmayı bırak ve işe geri dön."
...
translate turkish sm1cs_ag001_357d0aea:
    ...
    am "Anna'nın masasının yanında, elinizde penisinizle durmanız sizi daha iyi bir kodlayıcı yapmayacak."
...
translate turkish sm1cs_ag001_7f5ba7eb:
    ...
    mct "Sanırım Anna'nın masasının etrafında dolaşıyordum."
...
translate turkish sm1cs_ag001_9cc4e3c6:
    ...
    mct "Gerçekten onun mahremiyetine saygı göstermeliyim."
...
translate turkish sm1cs_ag001_8a816ec3:
    ...
    mct "Ama... küçük bir bakışın kimseye zararı olmaz."
...
translate turkish sm1cs_ag001_0942d02c:
    ...
    ag "Şuna mı bakıyorsun? Sevgiliye iç çamaşırı mı?"
...
translate turkish sm1cs_ag001_2f61628f:
    ...
    mc "Ha? Hiçbir şey. Sadece şey. Spam. Evet, spam e-posta."
...
translate turkish sm1cs_ag001_52303856:
    ...
    ag "Hepimizin ara sıra internette gezinerek vakit kaybettiğini biliyorsun. Tabii, belki Nisan hariç."
...
translate turkish sm1cs_ag001_125c77a2:
    ...
    ag "Bu kadar endişelenmenize gerek yok."
...
translate turkish sm1cs_ag001_be48f41c:
    ...
    mc "Ben mi? Endişelen. Hayır. Olabilecek en havalı... havalı."
...
translate turkish sm1cs_ag001_3fbddb39:
    ...
    ag "Tamam, peki, programım resmen belli oldu. Başkaları beni köşeye sıkıştırmadan önce toplantıyı yapalım."
...
translate turkish sm1cs_ag001_6e6ec012:
    ...
    mc "Hayır. Yani, evet. Her şey yolunda, Anna. Peki bu toplantıda neler oluyor?"
...
translate turkish sm1cs_ag001_b46d4c68:
    ...
    ag "Sadece küçük bir gayrı resmi kontrol ve inceleme."
...
translate turkish sm1cs_ag001_ad489d96:
    ...
    ag "Sadece uğrayıp işlerin nasıl gittiğini görmek istedim. Sana birkaç sorum olacak. Bakalım."
...
translate turkish sm1cs_ag001_5e597bfc:
    ...
    ag "Orbix'te çalışmayı nasıl buluyorsun?"
...
translate turkish sm1cs_ag001_4fd1a864:
    ...
    mc "Hoşuma gidiyor. İş oldukça zorlu ama her gün yeni bir şeyler öğrendiğimi hissediyorum."
...
translate turkish sm1cs_ag001_d69db481:
    ...
    ag "Bu iyi. Gıdıklanan bir zihin aktif bir zihindir."
...
translate turkish sm1cs_ag001_34edd7cf:
    ...
    ag "İş yükü hakkında daha fazla konuşalım. Bunun sizin için çok zorlayıcı olduğunu düşünüyor musunuz?"
...
translate turkish sm1cs_ag001_3e94ff89:
    ...
    mc "Tüm farklı çerçeveleri ve bunların nasıl senkronize edileceğini anlamanın biraz zor olabileceğini kabul ediyorum."
...
translate turkish sm1cs_ag001_91590991:
    ...
    ag "Şunu unutma ki, işler zorlaştığında, düzeltmek için her zaman bana gelebilirsin."
...
translate turkish sm1cs_ag001_094821e1:
    ...
    ag "Bulut bilişim söz konusu olduğunda bu eller doğuştan katillerdir."
...
translate turkish sm1cs_ag001_9be3ad46:
    ...
    ag "Eğer bir sorunun varsa, gel benimle konuş, sorunları birlikte çözelim dedim."
...
translate turkish sm1cs_ag001_35eaecfa:
    ...
    mc "Benim için değil. Ben her zaman yeni zorluklara hazırım."
...
translate turkish sm1cs_ag001_2d1662c3:
    ...
    ag "Harika! CUM Bölümü için ihtiyacımız olan tutum tam da bu."
...
translate turkish sm1cs_ag001_fc1b518f:
    ...
    ag "Her şeyin üstünde olmaktan hoşlandığını duyduğuma sevindim, [mcname]."
...
translate turkish sm1cs_ag001_next_choice_6984752f:
    ...
    mc "Üstte, altta, yandan, her zaman gitmeye hazırım."
...
translate turkish sm1cs_ag001_next_choice_7c1672a3:
    ...
    mc "Bir takımda olduğunuzda herkesin üzerine düşeni yapması gerekir."
...
translate turkish sm1cs_ag001_continue_8becb149:
    ...
    ag "İş arkadaşlarınızla iyi geçiniyor musunuz?"
...
translate turkish sm1cs_ag001_continue_f8d095b6:
    ...
    mc "Ah evet. Başladığımdan beri her şey yolunda gidiyor."
...
translate turkish sm1cs_ag001_continue_9e2ce674:
    ...
    mc "Buradaki herkes bana çok destek oldu."
...
translate turkish sm1cs_ag001_continue_51a879c2:
    ...
    mc "İyiydi ama April ile çalışmak kesinlikle biraz yoğundu."
...
translate turkish sm1cs_ag001_continue_98f3a5be:
    ...
    ag "Ah evet. Yoğun, sinir bozucu, tartışmacı. İstediğinde tam bir baş belası olabiliyor."
...
translate turkish sm1cs_ag001_continue_7a22d199:
    ...
    mc "Evet. Sana neden Patlıcan Anna diyor?"
...
translate turkish sm1cs_ag001_continue_5826ec07:
    ...
    ag "Ah, bu sadece... aramızda küçük bir şaka."
...
translate turkish sm1cs_ag001_continue_66ec0be3:
    ...
    ag "Belki sana ileride bir tane verir. Heh."
...
translate turkish sm1cs_ag001_continue_bc45666e:
    ...
    ag "Aslında bu bir soru değil. Yeni bir müşterimiz geliyor ve CUM Bölümü konuyu ele alacak ve onunla el ele çalışacak."
...
translate turkish sm1cs_ag001_continue_cd952fa6:
    ...
    mc "İstediğin kadar ileri gidebilirsin, Anna."
...
translate turkish sm1cs_ag001_continue_b6a91e84:
    ...
    mc "Seni hayal kırıklığına uğratmayacağım, Anna."
...
translate turkish sm1cs_ag001_continue_ad4c7889:
    ...
    ag "Harika. Sanırım burada işimiz bitti."
...
translate turkish sm1cs_ag001_continue_9127145a:
    ...
    ag "Ah evet. Düşüncelerimi Claire'e ileteceğim, ona şu ana kadar harika bir iş çıkardığını söyle, [mcname]."
...
translate turkish strings:
    ...
    new "İş Zorluğunu Arttır"

    # game/code/scenes/it_office/ag/sm1cs-ag001.rpy:64
    old "Do not increase Difficulty"
    new "Zorluğu Arttırma"
    ...
    new "Her şey yolunda gitti"

    # game/code/scenes/it_office/ag/sm1cs-ag001.rpy:376
    old "April is intense"
    new "Nisan yoğun geçiyor"

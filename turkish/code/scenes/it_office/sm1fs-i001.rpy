...
translate turkish sm1fs_i001_8539a6b4:
    ...
    ag "Benim adım Anna Goodwin, ilk tur mülakatlarından ben sorumluyum."
...
translate turkish sm1fs_i001_cb3bba2b:
    ...
    ag "Şirketin büyüyen bir bölümünün ekip lideriyim."
...
translate turkish sm1fs_i001_f1001075:
    ...
    ag "Tamam [mcname], Orbix'te çalışmakla neden ilgileniyorsun?"
...
translate turkish sm1fs_i001_aec7078a:
    ...
    mc "*öksürür* Tamam, peki, şey... Bu uygulamayı indirdim ve silemedim. Kullanmaya devam ettim ve hayatımın en güzel anlarından bazılarını yaşamama sebep oldu."
...
translate turkish sm1fs_i001_3e0bb4a1:
    ...
    mc "Ve en kötülerinden bazıları. Ama silemedim. Sıkışmıştım."
...
translate turkish sm1fs_i001_d8be561c:
    ...
    mc "Bana çok yakın biri, kodlama ve teknolojiyle neler yapabileceğimizi bana göstermeye başladı."
...
translate turkish sm1fs_i001_45589993:
    ...
    mc "Ve onun yardımı sayesinde, onu silebildim ve hayatıma devam edebildim. Bunun tek sebebi onun teknoloji hakkında çok şey bilmesiydi."
...
translate turkish sm1fs_i001_b2fdf6f2:
    ...
    ag "Bir gün bana tüm hikayeyi anlatmak zorunda kalacaksın."
...
translate turkish sm1fs_i001_47c47bec:
    ...
    am "Ben hala son projenizdeki tarafınızı bekliyorum."
...
translate turkish sm1fs_i001_5f80091e:
    ...
    ag "Takım lideri işini yapıyorum. Biliyorsun, çünkü terfi aldım."
...
translate turkish sm1fs_i001_e1871f26:
    ...
    am "2004'ten kalma çalınmış bir Makbuz'a sahip cahil bir yetimin bunu şimdiye kadar bitirebileceğini biliyorsun."

# game/code/scenes/it_office/sm1fs-i001.rpy:108
translate turkish sm1fs_i001_b7ef7f95:

    # ag "*Whispers* You suck."
    ag "*Fısıldar* Sen berbatsın."
...
translate turkish sm1fs_i001_32bf9044:
    ...
    am "Sadece canım istediğinde, Patlıcan Anna."
...
translate turkish sm1fs_i001_44f2a2b5:
    ...
    ag "Deneyiminize bakılırsa, biraz sıra dışı da olsa, bu iş için niteliklisiniz gibi görünüyor."
...
translate turkish sm1fs_i001_fc7441b6:
    ...
    ag "Biz 21. yüzyıl şirketiyiz. Çalışanlarımızın iş dışında bir şeye sahip olmalarını da istiyoruz."
...
translate turkish sm1fs_i001_0bc8be62:
    ...
    ag "İş dışında ne tür hobileriniz var?"
...
translate turkish sm1fs_i001_06874239:
    ...
    mc "Hiçbir zaman bana ne yapmaktan hoşlandığımı soran bir çalışma ortamında bulunmadım."
...
translate turkish sm1fs_i001_0cae1c03:
    ...
    mc "Sanırım kitapları her şeyden daha çok seviyorum."
...
translate turkish sm1fs_i001_1ba370a1:
    ...
    ag "Üzgünüm, aslında bana söyleme. Dikkatim dağılır ve röportajı bitiremeyiz."
...
translate turkish sm1fs_i001_362d84fb:
    ...
    mc "Zaman bulduğumda spor yapmaktan gerçekten keyif alıyorum."

# game/code/scenes/it_office/sm1fs-i001.rpy:167
translate turkish sm1fs_i001_8300dfd8:

    # ag "Sounds... Relaxing?"
    ag "Kulağa... Rahatlatıcı Geliyor mu?"
...
translate turkish sm1fs_i001_42041c8f:
    ...
    mc "Zaman zaman oturup birkaç saat boyunca sadece video oyunları oynuyorum."
...
translate turkish sm1fs_i001_0133cbf7:
    ...
    ag "FPS oyunlarına bayılıyorum. Contrary Strike'da harikayım."
...
translate turkish sm1fs_i001_bb860b1d:
    ...
    mc "Bunu oynayalı uzun zaman oldu."
...
translate turkish sm1fs_i001_0ad4fbbc:
    ...
    mc "Arabaları gerçekten seviyorum. Kaslı arabalar, pony arabalar veya paslı kovalar. Onları çok seviyorum."
...
translate turkish sm1fs_i001_0aacc7c7:
    ...
    ag "Muhtemelen hoşunuza gidecek bir şey. Çalışmanıza yardımcı olacak."
...
translate turkish sm1fs_i001_cd963929:
    ...
    ag "Ama bu iyi. İşten sonra rahatlamanın bir yolunun olması önemli."
...
translate turkish sm1fs_i001_first_success_c7763a5f:
    ...
    ag "Harika iş çıkardın. Takıma harika bir katkı sağlayacağını düşünüyorum."
...
translate turkish sm1fs_i001_first_fail_d19214c0:
    ...
    ag "Ahhh, neyi yanlış yaptığını anladım."
...
translate turkish sm1fs_i001_first_fail_635a7db3:
    ...
    ag "Bir kez daha denemek ister misin?"
...
translate turkish sm1fs_i001_second_success_29b81034:
    ...
    ag "Hiç merak etme [mcname]. Orbix'te çalışmak için gereken becerilere sahipmişsin gibi görünüyor!"

# game/code/scenes/it_office/sm1fs-i001.rpy:322
translate turkish sm1fs_i001_got_hired_ad35731a:

    # mc "Awesome, when do I start?"
    mc "Harika, ne zaman başlıyorum?"
...
translate turkish sm1fs_i001_got_hired_4b39318d:
    ...
    ag "Aslında ikinci bir röportaj daha var."
...
translate turkish sm1fs_i001_got_hired_8b26d4b4:
    ...
    mc "Ah. Senin takım lideri olduğunu sanıyordum?"
...
translate turkish sm1fs_i001_got_hired_bb568305:
    ...
    ag "Sizinle çalışmayı sabırsızlıkla bekliyorum!"
...
translate turkish sm1fs_i001_got_hired_de256a59:
    ...
    ag "Claire ile buluştuğunda onu üzmediğin sürece."
...
translate turkish sm1fs_i001_fail_3cff05ba:
    ...
    ag "Ama biz her zaman potansiyel adayları test ediyoruz!"
...
translate turkish sm1fs_i001_fail_5e23fd89:
    ...
    ag "Neden geri dönüp başka bir zaman tekrar denemiyorsun?"
...
translate turkish sm1fs_i001_fail_40fd39a9:
    ...
    ag "Mülakatı geçtiğinizde bana teşekkür edin."
...
translate turkish sm1fs_i001_fail_6284e564:
    ...
    mc "Endişelenme, beni tekrar göreceksin."
...
translate turkish sm1fs_i001_fail_try_again_bfa956ca:
    ...
    ag "Elbette hatırladım, sen harika bir potansiyel adaysın."
...
translate turkish sm1fs_i001_fail_try_again_d273f447:
    ...
    ag "Sınav hakkında daha iyi hissediyor musun?"
...
translate turkish sm1fs_i001_fail_try_again_8db073a0:
    ...
    ag "Ne zaman hazır olursanız başlayın."
...
translate turkish sm1fs_i001_got_hired_e9780151:

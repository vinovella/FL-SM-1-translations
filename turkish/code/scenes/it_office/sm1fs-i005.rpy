...
translate turkish sm1fs_i005_7a2fe859:
    ...
    ag "Fena değil. Bir süredir bir problem üzerinde çalışıyordum. Gerçek bir beyin jimnastiği."
...
translate turkish sm1fs_i005_cd403d8a:
    ...
    ag "Aklımı problemden uzaklaştırmak için Skelstorm: Komach's Revenge'ın yeni güncellemesini oynamaya karar verdim."
...
translate turkish sm1fs_i005_d32f8004:
    ...
    ag "Sonunda sunucuya bağlandım ve aklıma geldi."
...
translate turkish sm1fs_i005_c58b7d65:
    ...
    sr "Ya da squatlarını dışarıda yapabilirsin?"
...
translate turkish sm1fs_i005_89b479ce:
    ...
    jh "Sakin ol. Neredeyse bitirdim."
...
translate turkish sm1fs_i005_d1a15a84:
    ...
    mct "Belki bir ara bunu Stacy ile yapmayı düşünmeliyim."
...
translate turkish sm1fs_i005_99cd567e:
    ...
    sr "Hemen gidip Maureen'i yakalayacağım."
...
translate turkish sm1fs_i005_fd1ebc41:
    ...
    "Aktör 1" "Evet. Öp onu.{w} Şu taşakları em."
...
translate turkish sm1fs_i005_525b4a71:
    ...
    jh "Kahretsin. Control alt delete."
...
translate turkish sm1fs_i005_f61762d0:
    ...
    jh "İhtiyacım yok. Dokuzluklar buluyorum.{w} Her zaman."
...
translate turkish sm1fs_i005_99ecf24c:
    ...
    am "*alay eder* Bu kadar hızlı mı? Lisede olup kodlama hakkında hiçbir şey bilmiyormuş gibi mi davranıyoruz?"

# game/code/scenes/it_office/sm1fs-i005.rpy:307
translate turkish sm1fs_i005_afbd7187:

    # sr "Ugh. April, come on."
    sr "Ugh. April, hadi ama."
...
translate turkish sm1fs_i005_203ae35b:
    ...
    ag "[mcname]. Şu TPS raporların yok mu-"
...
translate turkish sm1fs_i005_9c7dcd9a:
    ...
    am "Güzel bir saç kesimine sahip bir ölü ağırlığa ihtiyacımız olduğunda seni ararız."
...
translate turkish sm1fs_i005_6b9da9c1:
    ...
    ml "İşte bu yüzden ülkemiz batıyor."
...
translate turkish sm1fs_i005_19376701:
    ...
    ml "Pek çok insan kovulmak üzere."
...
translate turkish sm1fs_i005_1d74550d:
    ...
    ml "Sana yardım edebilir miyiz? Libby'nin ekranı hâlâ müstehcenlikle bozulmuş."
...
translate turkish sm1fs_i005_6d100274:
    ...
    en "Sadece saf sevinç ve aşk. Hepimizin hayatlarımızda bundan daha fazlasına sahip olması gerekir."
...
translate turkish sm1fs_i005_d4390c40:
    ...
    lm "Onunki gibi memeler geliştir Eugene ve eminim onları emecek birini bulursun."
...
translate turkish sm1fs_i005_2504b379:
    ...
    en "Ah, şimdi 'Üç sırtlı canavar'a başlıyorlar."
...
translate turkish sm1fs_i005_7d921c6c:
    ...
    en "Bu, {b}benim{/b} ekranımda olanlardan çok daha iyi."
...
translate turkish sm1fs_i005_bd4c8cdb:
    ...
    ag "Dosya dizini sales slash two-thousand-twenty slash Oh Bee Jay slash archive'de."
...
translate turkish sm1fs_i005_447a59a7:
...
translate turkish sm1fs_i005_6887c6fa:
    ...
    am "Beyin temizliği için bir şeye ihtiyacın var."
...
translate turkish sm1fs_i005_93ec2d34:
    ...
    cw "Yani herkes bir şeyler görmüştür. Bu internet."
...
translate turkish sm1fs_i005_deb5108d:
    ...
    cw "Bazen saf bir kazayla bir şeyler görürsün."
...
translate turkish sm1fs_i005_eaee6bb2:
    ...
    cw "Orbix monitörlerine ait değiller."
...
translate turkish sm1fs_i005_a6fa439a:
    ...
    cw "Ve bazıları öldürme düğmesine basmanın virüsü durdurmadığını ve sadece Sienna, Anna ve April için daha fazla iş eklediğimi söyleyecek."
...
translate turkish sm1fs_i005_2679ca0d:
    ...
    cw "Bilirsin. Birçok kahraman kendi zamanında yanlış anlaşılır."
...
translate turkish sm1fs_i005_810db49c:
    ...
    cw "Cesur eylemleri daha sonra gerçekten tanınır."
...
translate turkish sm1fs_i005_3f44db59:
    ...
    mc "Ne olduğunu açıklamak için mi?"
...
translate turkish sm1fs_i005_e849418f:
    ...
    cw "Kesinlikle. İhtiyaç duymayacağımı umuyorum, ama {i}benim{/i} patronumla asla bilemezsin."
...
translate turkish sm1fs_i005_conference_9d3858d5:
    ...
    cw "Tamamen anladığımdan emin olmak için."
...
translate turkish sm1fs_i005_conference_2b5bfce0:
    ...
    cw "Ve ana şüphelimiz Angela'nın bizi uyardığı bu trol."
...
translate turkish sm1fs_i005_conference_96ec6c94:
    ...
    am "Kimse adamın lanet olası Neo ve Mr. Robot karışımı olduğunu söylemedi."
...
translate turkish sm1fs_i005_conference_dcb247c1:
    ...
    ag "Nari'nin sistemine teşekkürler, onun sistemi olmasaydı olacağından çok daha kısa bir sürede Orbix'e saldıranı bulabileceğiz."
...
translate turkish sm1fs_i005_conference_e52fecb0:
    ...
    ag "Ama Sienna'nın ya da birimizin bir düzeltme bulması sadece zaman meselesi."
...
translate turkish sm1fs_i005_conference_f52a2354:
    ...
    cw "Konuya geri dönersek, mevcut çözümümüzün uzun vadeli olmadığını mı söylüyorsun?"
...
translate turkish sm1fs_i005_conference_b544b853:
    ...
    am "Ah evet.{w} Hayır, bu kesinlikle problemi durduracak."
...
translate turkish sm1fs_i005_conference_fce39087:
    ...
    cw "Peki bunu nasıl düzelteceğiz?"
...
translate turkish sm1fs_i005_conference_c8a9892b:
    ...
    am "Sienna ana işlevlerimizin...{w} İşlev görmesi için yedek sistemleri çevrimiçi hale getirmek için elinden geleni yapıyor."
...
translate turkish sm1fs_i005_conference_96bc0e75:
    ...
    ag "Bu yapıldığında, evet, sistemlerimizi tamamen düzeltmek mümkün."
...
translate turkish sm1fs_i005_conference_08fe18ca:
    ...
    am "Ve hâlâ haber web sitesini yapıyoruz."
...
translate turkish sm1fs_i005_conference_f1db57cb:
    ...
    am "Beni bundan çıkarmak her şeyin geciktiği anlamına gelir."
...
translate turkish sm1fs_i005_conference_c7ee5017:
    ...
    cw "Tüm çeyrek için C.U.M Bölümü'ne kara leke olur."
...
translate turkish sm1fs_i005_conference_1221d722:
    ...
    ag "Şanslıysak, kök kodu çözebilir ve bozuk verileri yakabilirler."
...
translate turkish sm1fs_i005_conference_1e00e190:
    ...
    cw "B planı ne? Daha hızlı seçenek ne?"
...
translate turkish sm1fs_i005_conference_963b94a1:
    ...
    ag "Yedekleme sistemlerini yükleyebiliriz."
...
translate turkish sm1fs_i005_conference_8c2518b0:
    ...
    ag "Ama gerçek konuşma? Zafiyetleri bulmak ve onları tıkamak için zaman harcamadan?"
...
translate turkish sm1fs_i005_conference_bbc86966:
    ...
    cw "Yap. Gecikme için zamanımız yok."
...
translate turkish sm1fs_i005_conference_da6144a4:
    ...
    ag "Yani Nari ve [mcname]. Siz ikiniz yaptığınız şeyi yapmaya devam edin."
...
translate turkish sm1fs_i005_conference_34d0f802:
    ...
    ag "Ama Bayan Watts. Web sitesini bitirdiğimiz anda, açığı bulup tıkamamız gerekiyor."
...
translate turkish sm1fs_i005_conference_b9f751c3:
    ...
    am "Evet. Ya da başa dönmüş olacağız."
...
translate turkish sm1fs_i005_conference_a31da267:
    ...
    cw "Daha önce zaten baskı altındaydık."
...
translate turkish sm1fs_i005_conference_7a2695d5:
    ...
    cw "Şimdi bu hack yüzünden bir günü ve kim bilir başka neler kaybettik."
...
translate turkish sm1fs_i005_conference_53902fad:
    ...
    ag "Evet. Ve sanırım kafein almaya gideceksin?"
...
translate turkish sm1fs_i005_conference_dbad630f:
    ...
    am "Roketler yakıt olmadan uçmaz. Otuz dakika içinde markettan dönerim."
...
translate turkish sm1fs_i005_conference_5b5f248a:
    ...
    ag "Ama en kötüsünün geçtiğinden eminim."
...
translate turkish sm1fs_i005_conference_569e04e7:
    ...
    ag "O yüzden atlarımıza binelim ve C.U.M Bölümü'nü gururlandıralım."
...
translate turkish sm1fs_i005_conference_b46a79f6:
    ...
    ag "Yirmi dakika içinde size güncellenmiş kod paketlerini göndereceğim."

...
translate turkish sm1ms012_a6339388:
    ...
    sy "Bu yüzden yapmam gereken son şey, onu bir gece boyunca işlemekti, aaaaa ve az önce kontrol ettim."

# game/code/scenes/main_story/sm1ms012.rpy:12
translate turkish sm1ms012_59612945:

    # sy "No errors, no glitches!"
    sy "Hata yok, aksaklık yok!"
...
translate turkish sm1ms012_6f277d18:
    ...
    mc "Hadi ama, Stacy. Beni burada merakta bırakma!"
...
translate turkish sm1ms012_f993846c:
    ...
    mc "Bayıldılar mı? Nefret mi ettiler? Hadi! Söyle bana!"
...
translate turkish sm1ms012_3be8dcea:
    ...
    sy "Hı hı! O kadar beğendiler ki, bir porno daha sipariş etmeye karar verdiler!"
...
translate turkish sm1ms012_e26be9cc:
    ...
    mc "Aman Tanrım - tamam. Yani bir sonraki videoya hazırlanmaya başlamamız gerekiyor, ha?"
...
translate turkish sm1ms012_57daa323:
    ...
    sy "Müşterinin gönderdiğimiz ürün hakkında gerçekten iyi notları ve düşünceleri vardı."
...
translate turkish sm1ms012_e4fa9889:
    ...
    sy "Bu beni işin daha az eğlenceli kısmına getiriyor..."
...
translate turkish sm1ms012_d817f264:
    ...
    sy "Çok büyük bir mesele değil ama..."
...
translate turkish sm1ms012_5e983ecb:
    ...
    sy "Stüdyo ile ilgili bir şeyler yapmamız gerekebilir."
...
translate turkish sm1ms012_0abd0e9d:
    ...
    sy "Bir sonraki video daha spesifik. Yani ya bir yer bulmamız gerekecek ya da onu burada tekrar çekmemiz gerekecek."

# game/code/scenes/main_story/sm1ms012.rpy:82
translate turkish sm1ms012_dad45c2a:

    # mc "What's the next thing they want?"
    mc "Sırada ne istiyorlar?"
...
translate turkish sm1ms012_399dbd6a:
    ...
    sy "Yine kırmızı peruk takmamı istiyorlar."
...
translate turkish sm1ms012_1f28064d:
    ...
    sy "Ama bu sefer çiftçi olmamı istiyorlar. Tulum ve her şey."
...
translate turkish sm1ms012_d7e6c6f4:
    ...
    sy "Ve bunun vahşi bir anal sahne olmasını istiyorlar. Bir ahırda."
...
translate turkish sm1ms012_60f4453d:
    ...
    sy "Bu yüzden seçeneklerimiz ya bir çiftlik bulmak ya da bir çiftlik kurmak."
...
translate turkish sm1ms012_fe0f68de:
    ...
    sy "Her zaman AmRose'a sorabiliriz. Ailesinin bir çiftliği yok mu?"
...
translate turkish sm1ms012_f2afb73c:
    ...
    mc "Sanırım artık bizimle bir sorunu yok ama bunun onun hoşuna gideceği bir şey olup olmadığından da emin değilim."
...
translate turkish sm1ms012_109fb62f:
    ...
    sy "Sanırım bu da kendi çözümümüzü üretmemiz gerektiği anlamına geliyor."
...
translate turkish sm1ms012_ebce743a:
    ...
    sy "Evet, bir krom yeşil sistemi yapabiliriz. Aslında... aslında dürüst olmak gerekirse, uğraşmak isteyip istemediğimizden emin olmadığımız birçok sorunu var."
...
translate turkish sm1ms012_e8addbef:
    ...
    sy "Eh, bu post-işleme için çok fazla zaman ekliyor. Ve ayrıca üretim için de çok fazla zaman demek. Ve ekipman maliyeti-"

# game/code/scenes/main_story/sm1ms012.rpy:133
translate turkish sm1ms012_1e734161:

    # mc "What are you saying, Stacy?"
    mc "Ne diyorsun, Stacy?"
...
translate turkish sm1ms012_33766a51:
    ...
    sy "Kısa versiyon - eğer yeşil ekran yapıyorsanız, yeşil ekranın eşit şekilde aydınlatıldığından emin olmanız gerekir."
...
translate turkish sm1ms012_f82eebaf:
    ...
    sy "Çünkü eğer öyle değilse, bir sürü soruna yol açacaktır. İkinci şey, düzenlemedir."
...
translate turkish sm1ms012_d5b30f08:
    ...
    sy "Düzenlerken çok fazla ince ayar yapmak gerekir. Aksi takdirde herkesin bu garip yeşil taslağa sahip olmasıyla sonuçlanır."
...
translate turkish sm1ms012_7eefe188:
    ...
    sy "Bazı eski dizileri izlerseniz, yeşil ekran kullandıkları zamanları görmeye başlayabilirsiniz, çünkü ya tuhaf yeşil bir parıltıya sahiptirler ya da kenarları biraz bulanıktır."
...
translate turkish sm1ms012_8fba05e0:
    ...
    mc "Film yapımcılığı hakkında bu kadar çok şeyi ne zaman öğrendin?"
...
translate turkish sm1ms012_697a89ff:
    ...
    sy "Sen dışarıda aktris bulmaya çalışırken, ben bilgisayarda film yapımıyla ilgili her şeyi öğreniyorum."
...
translate turkish sm1ms012_19862231:
    ...
    sy "Ne? Sadece sen odadayken mi var olduğumu sanıyorsun?"
...
translate turkish sm1ms012_794a7b10:
    ...
    mc "Şey - hayır. Öğrenme konusunda bu kadar proaktif olacağını düşünmemiştim."
...
translate turkish sm1ms012_a09919b9:
    ...
    sy "Hey, bu benim de hayalim. Bunu gerçekleştirmek için elimden gelen her şeyi yapmak istiyorum."

# game/code/scenes/main_story/sm1ms012.rpy:158
translate turkish sm1ms012_d08750b9:

    # mc "So... green screen is out."
    mc "Yani... yeşil ekran artık yok."
...
translate turkish sm1ms012_fe2dd872:
    ...
    sy "En azından şimdilik. Ama yapabileceğimiz başka bir şey buldum."
...
translate turkish sm1ms012_11174fbc:
    ...
    sy "Bazı muslin fonlar alabiliriz. Bazılarının üzerinde baskılı fonlar var. Ve en popüler fonlardan birinin ne olduğunu biliyor musun?"

# game/code/scenes/main_story/sm1ms012.rpy:166
translate turkish sm1ms012_180f6f13:

    # mc "Let me guess. Barn?"
    mc "Tahmin edeyim. Ahır mı?"
...
translate turkish sm1ms012_1fb2708c:
    ...
    sy "Ama evet - şu anda fotoğrafçılıkla uğraşan tüm o futbolcu anneler bize gerçekten yardımcı oluyor."
...
translate turkish sm1ms012_197c633f:
    ...
    mc "Ahır arka planlarının bu kadar popüler olmasının sebebi bu mu?"
...
translate turkish sm1ms012_98f0153f:
    ...
    sy "Aslında değil... Taşınmadan önce onunla biraz konuştum. Ama stüdyo ile o kadar meşguldüm ki... vakit bulamadım."
...
translate turkish sm1ms012_fb6838e3:
    ...
    sy "Hayır. Çok ama çok meşguldüm."
...
translate turkish sm1ms012_e644fac5:
    ...
    mc "Her şey... gerçek olmaya başlıyor, biliyor musun?"
...
translate turkish sm1ms012_70db2923:
    ...
    sy "İlk videoyu göndermek, tüm bu rüyayı daha önce hiç olmadığı kadar somut hale getirdi."
...
translate turkish sm1ms012_07bfeb11:
    ...
    sy "Bilmiyorum... taşındığımızdan beri pek bakmadık."
...
translate turkish sm1ms012_b0104bc3:
    ...
    mc "Zaten olduğumuzdan daha fazla değil."
...
translate turkish sm1ms012_08644055:
    ...
    sy "Ne kadar çılgın olduğumuzun biraz farkında olmak iyidir. Bu, henüz tamamen çıldırmamış olduğumuz anlamına gelir."
...
translate turkish sm1ms012_9017a609:
    ...
    sy "Şey... sanırım stüdyo üzerinde çalışmaya başlamamız gerekiyor."
...
translate turkish sm1ms012_f6cd0b2d:
    ...
    sy "Birkaç telefon görüşmesi yapacağım, birkaç müteahhit bulacağım... burada bir tadilatın ne kadara mal olacağına dair fiyat teklifi alacağım..."
...
translate turkish sm1ms012_cb5ef835:
    ...
    mc "Yeni müşteri bir sonraki videosunu ne zaman istiyor?"
...
translate turkish sm1ms012_2b94ace5:
    ...
    sy "Muhtemelen en kısa sürede. Heyecanlı görünüyorlardı? Çoğunlukla?"
...
translate turkish sm1ms012_df8505ee:
    ...
    sy "Evet... saldırgan falan değildi... sadece birazcık zorlayıcıydı belki."
...
translate turkish sm1ms012_3ff3c6af:
    ...
    sy "Şöyle ki... bunu olabildiğince hızlı yapmamız gerekiyordu."
...
translate turkish sm1ms012_010cabca:
    ...
    sy "Ama belki de havayı doğru okuyamadım. Belki de sadece ilk videolarını çekmek için heyecanlıydılar."
...
translate turkish sm1ms012_4c32c6c9:
    ...
    sy "Bu yüzden onlara bir sonraki videoyu er ya da geç ulaştırmak iyi olur."
...
translate turkish sm1ms012_5efbd0b4:
    ...
    sy "Hadi, hadi başlayalım. Tanrı biliyor ya, bu tadilat için çok sıvıya ihtiyacımız olacak."
...
translate turkish sm1ms012_1b14a467:
    ...
    mc "Güzel fikir! Gidip zor kazandığımız parayı kazanalım."

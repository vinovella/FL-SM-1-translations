...
translate turkish sm1ms024_239e63a5:
    ...
    sy "Yatma vakti yaklaşıyor ve burası çok sıcak!{w} Beni dava et!"
...
translate turkish sm1ms024_78ef9e00:
    ...
    sy "Biliyorsunuz, videoların işlenmesi GPU'nun başlamasına neden oluyor ve ısınmaya neden oluyor."
...
translate turkish sm1ms024_835dcbb5:
    ...
    sy "PC'nin yanında çok sıcak oluyor.{w} Düzenleme yaptığım zamanın yarısında, orada çıplak oturuyorum."

# game/code/scenes/main_story/sm1ms024.rpy:44
translate turkish sm1ms024_a2803d51:

    # mc "That's the {i}only{/i} reason you're naked?"
    mc "Çıplak olmanın {i}tek{/i} nedeni bu mu?"
...
translate turkish sm1ms024_dd8c835f:
    ...
    sy "Evet, [mcname], zaten çıplaksam mastürbasyon yapmak daha kolay."
...
translate turkish sm1ms024_0cc05a1a:
    ...
    mc "Neyse, video zaten hazırdı? Her şeyi düzenlendi, render edildi ve her şey tamam mı?"
...
translate turkish sm1ms024_7c360129:
    ...
    sy "Evet, bu öğleden sonra gönderdim ve müşteri zaten geri bildirim gönderdi!"
...
translate turkish sm1ms024_5ed6af01:
    ...
    mc "Tamam... kompozisyonu, ışığı beğendi... videonun çok ateşli olduğunu düşünüyor, popo kısmını ve kırmızı perukları çok seviyor..."
...
translate turkish sm1ms024_8651a87f:
    ...
    mc "İyi şeyler, ve daha fazla iyi şeyler... kısacası, sadece olumlu bir eleştiri."
...
translate turkish sm1ms024_111e7bcc:
    ...
    mc "Bekle... bu neyle ilgili... izin mi?{w} Ne için izin?"
...
translate turkish sm1ms024_b52fd7cb:
    ...
    sy "Yani... seninle konuşmak istediğim bir konuydu bu."
...
translate turkish sm1ms024_705afcf0:
    ...
    sy "Stüdyo için bir web sitesi kurmuş olabilirim."
...
translate turkish sm1ms024_071367c1:
    ...
    sy "Yenilemenin bittiğini düşündüğüm için artık içerik üretmeye başlayabiliriz."
...
translate turkish sm1ms024_6efaebee:
    ...
    sy "Ve her iyi işletmenin kendi web sitesi vardır. Tüm iletişim bilgileri ve benzeri şeylerle birlikte."

# game/code/scenes/main_story/sm1ms024.rpy:92
translate turkish sm1ms024_dd616c3e:

    # mc "Are you sure we're ready?"
    mc "Hazır olduğumuzdan emin misin?"
...
translate turkish sm1ms024_7b24a2e2:
    ...
    sy "Evet. Ve web sitesi videolarımızı barındırmak için harika bir yer olacak."
...
translate turkish sm1ms024_d331e84d:
    ...
    sy "Yeni müşteriler bulmaya çalışmak için kullan. Yeterli trafiğimiz olursa, biraz reklam geliri elde etmeye başlayabiliriz."

# game/code/scenes/main_story/sm1ms024.rpy:96
translate turkish sm1ms024_aab0a636:

    # sy "Maybe... just maybe..."
    sy "Belki... sadece belki..."

# game/code/scenes/main_story/sm1ms024.rpy:101
translate turkish sm1ms024_3f7ab5fe:

    # sy "Nah, that's crazy."
    sy "Hayır, bu çılgınlık."
...
translate turkish sm1ms024_3d671bd3:
    ...
    sy "Tamamdır. Sana ne düşündüğümü söyleyeceğim."
...
translate turkish sm1ms024_02d29ed4:
    ...
    sy "Düşünüyordum da...{w} belki de {i}kendi{/i} videolarımızı yapmaya başlamamızın zamanı geldi."

# game/code/scenes/main_story/sm1ms024.rpy:135
translate turkish sm1ms024_6a0b0114:

    # mc "But we're already making videos of us?"
    mc "Ama biz zaten kendimizin videolarını mı çekiyoruz?"
...
translate turkish sm1ms024_fd831723:
    ...
    sy "Hayır, demek istediğim... Sadece kendimiz yapabileceğimiz bir porno yapma isteği duydum."
...
translate turkish sm1ms024_224d32ea:
    ...
    sy "Bu yüzden bir müşterinin bize ne istediğini söylemesi yerine, kendi konseptimizi yaratacağız."
...
translate turkish sm1ms024_3b493156:
    ...
    sy "İstediğimiz fetişlerle kendi senaryomuzu yazalım.{w} Ve büyük oynayalım."
...
translate turkish sm1ms024_78ea74d0:
    ...
    sy "{b}Büyük{/b}. Sadece sahneler çekiyorduk.{w} Şimdi bir {b}filmin{/b} zamanı."
...
translate turkish sm1ms024_04ff0aa0:
    ...
    sy "Ve iş bittiğinde, bunu bağımsız bir dağıtımcıya veya benzeri bir yere satabiliriz."
...
translate turkish sm1ms024_5851d633:
    ...
    sy "Gerçek filmler yapacağımız için, umarım daha büyük müşteriler de bize gelip projelerini sunacaktır."

# game/code/scenes/main_story/sm1ms024.rpy:150
translate turkish sm1ms024_a03bec72:

    # sy "It's a win-freaking-win, baby!"
    sy "Bu çok kazançlı bir durum, bebeğim!"
...
translate turkish sm1ms024_dc7d93a9:
    ...
    mc "Peki ben neye bakıyorum? Stüdyoya mı?"
...
translate turkish sm1ms024_1e92ce73:
    ...
    sy "\"Ve [mcname] krallığının genişliğine baktı ve ağladı, çünkü fethedilecek daha çok dünya vardı.\""
...
translate turkish sm1ms024_b45e50d5:
    ...
    sy "Söylemeye çalıştığım şey, şu anda tüm bu alana sahibiz.{w} Genişlemek için tüm bu alana sahibiz.{w} Ve bunu kullanmalıyız!"

# game/code/scenes/main_story/sm1ms024.rpy:205
translate turkish sm1ms024_43c39b16:

    # mc "All right, well what's your bright idea?"
    mc "Peki, senin parlak fikrin ne?"
...
translate turkish sm1ms024_893f3db8:
    ...
    sy "Ne hakkında konuştuğun hakkında hiçbir fikrim yok, [mcname]."
...
translate turkish sm1ms024_2ef19219:
    ...
    mc "Sen benim kız kardeşimsin. Görünüşünün ne anlama geldiğini biliyorum."
...
translate turkish sm1ms024_2d7cad9c:
    ...
    mc "Sen benim en iyi arkadaşımsın. Görünüşünün ne anlama geldiğini biliyorum."
...
translate turkish sm1ms024_298f494f:
    ...
    mc "Ve şu anda, yüzün bir fikrin olduğunu haykırıyor."
...
translate turkish sm1ms024_73f87836:
    ...
    sy "Ve büyük bir etki yaratmak istiyoruz, değil mi?"
...
translate turkish sm1ms024_32b94f37:
    ...
    mc "Korsanlar pahalı görünüyor.{w} Kostümler, mekanlar, aksesuarlar derken... Sanırım bir kılıç dövüşü?"
...
translate turkish sm1ms024_ada90284:
    ...
    sy "Bu bir korsan filmi, tabii ki, bir kılıç dövüşü olması lazım."
...
translate turkish sm1ms024_a8ed2ce7:
    ...
    mc "Bütün bunlar gerçekten çok pahalı görünüyor. Ve bunun üstüne bir de sağlam birini bulmam gerekiyor."
...
translate turkish sm1ms024_0fb3e0b8:
    ...
    sy "Detaylar, detaylar. Bu o kadar da büyük bir mesele değil."
...
translate turkish sm1ms024_5af2f49c:
    ...
    sy "Sanırım bununla başa çıkmanın bir yolunu buldum."
...
translate turkish sm1ms024_cf7f5861:
    ...
    sy "Aslında iki tane var bende, [mcname]. Doğru yap."
...
translate turkish sm1ms024_16d1b0e1:
    ...
    sy "Ama, bir kredi çekip, kiminle yaparsak yapalım, hangi anlaşmayı yaparsak yapalım, geri ödeyebileceğimi düşünüyorum. Reklam veya dağıtım."

# game/code/scenes/main_story/sm1ms024.rpy:326
translate turkish sm1ms024_b68b4d89:

    # mc "I like your magic words, sexy lady."
    mc "Sihirli sözlerin hoşuma gitti, seksi kadın."
...
translate turkish sm1ms024_3e221bca:
    ...
    sy "Spandex kıyafetler, ateşli uzaylılar, tuhaf yeni dünyalar..."
...
translate turkish sm1ms024_10fea1d3:
    ...
    mc "Sanırım oturup tam olarak ne çekeceğimize karar vermemiz gerekiyor."
...
translate turkish sm1ms024_5497f8c4:
    ...
    mc "Ve daha da önemlisi, her filmde kimleri oynatacağımız."
...
translate turkish sm1ms024_25dee965:
    ...
    sy "Tamam, biraz kağıt, şey, not defteri almam lazım."
...
translate turkish sm1ms024_ef606456:
    ...
    sy "Ve senaryolarda daha iyi olmam gerekiyor, ve, ve-"
...
translate turkish sm1ms024_354881fa:
    ...
    sy "Hikaye Panoları!{w} Hikaye panolarına ihtiyacımız olacak!"
...
translate turkish sm1ms024_97772608:
    ...
    sy "Kanya'yı arayacağım ve, şey, internette bir şeyler bakmaya başlayacağım-"
...
translate turkish sm1ms024_873c63ce:
    ...
    mc "Güzel. Neden bir liste hazırlamıyorsun, birkaç gün içinde oturup filmimizi planlamaya başlayabiliriz."

# game/code/scenes/main_story/sm1ms024.rpy:448
translate turkish sm1ms024_f1352474:

    # sy "That sounds fucking awesome."
    sy "Bu harika görünüyor."
...
translate turkish sm1ms024_a7812ac1:
    ...
    mct "Kahretsin... Bunu gerçekten yapacağız. İlk filmimizin ön prodüksiyonu..."
...
translate turkish sm1ms024_620a96b9:

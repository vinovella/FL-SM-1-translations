...
translate deutsch sm1cs_kv002_9356c126:

    # mc "Hey Kanya."
    mc "Hey Kanya."

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:26
translate deutsch sm1cs_kv002_2ea7f9eb:

    # kv "Hey [mcname]. Haha. You have a talent for showing up just at the end of my shoots."
    kv "Hey [mcname]. Haha. Du hast ein Talent dafür, immer genau am Ende meiner Shootings aufzutauchen."

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:29
translate deutsch sm1cs_kv002_decc9713:

    # mc "What can I say?"
    mc "Was soll ich sagen?"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:31
translate deutsch sm1cs_kv002_360183ad:

    # kv "That you'll give me some heads up next time so we can just hang out?"
    kv "Dass du mir das nächste Mal Bescheid gibst, damit wir einfach zusammen abhängen können?"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:35
translate deutsch sm1cs_kv002_2b43865a:

    # mc "I promise to next time."
    mc "Ich verspreche es für das nächste Mal."

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:37
translate deutsch sm1cs_kv002_d6c3b738:

    # kv "Good. Grab a seat while I finish this up."
    kv "Gut. Setz dich doch, während ich das hier fertig mache."

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:40
translate deutsch sm1cs_kv002_439f1141:

    # kv "As long as that's cool with you."
    kv "Solange das für dich in Ordnung ist."
...
translate deutsch sm1cs_kv002_4601535a:

    # kv "Last Question; when do you start to see lens distortion from your focal length, often called the 'fishbowl effect'?"
    kv "Letzte Frage: Wann beginnt man, eine Verzerrung der Linse aufgrund der Brennweite zu erkennen, die oft als Fischaugeneffekt bezeichnet wird?"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:96
translate deutsch sm1cs_kv002_f8c88d48:

    # mc "Under 35mm, right?"
    mc "Unter 35 mm, richtig?"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:98
translate deutsch sm1cs_kv002_612be1cd:

    # kv "Yep! Once you're under 35mm you start to see distortion in the corners."
    kv "Ja! Sobald man unter 35 mm liegt, sieht man Verzerrungen in den Ecken."

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:101
translate deutsch sm1cs_kv002_d4be0d5e:

    # kv "I mean, you definitely read the book which is great."
    kv "Ich merke, du hast das Buch devinitiv gelesen, was toll ist."

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:103
translate deutsch sm1cs_kv002_bec64362:

    # kv "But I just had a fun idea. Why don't you try to take some of that theory and turn it into practice?"
    kv "Aber ich hatte gerade eine lustige Idee. Warum probierst du nicht mal, etwas von dieser Theorie in die Praxis umzusetzen?"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:105
translate deutsch sm1cs_kv002_11455b53:

    # mc "What?"
    mc "Was?"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:107
translate deutsch sm1cs_kv002_9ae2eac4:
    ...
    kv "Nun, ich habe alle Fotos, die ich brauche, und bin damit zufrieden. Wenn es ihr recht ist, könnte sie für uns modeln, und du könntest versuchen, dich hinter die Kamera zu stellen."

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:110
translate deutsch sm1cs_kv002_1a015882:

    # kv "You cool with that?"
    kv "Ist das für dich okay?"
...
translate deutsch sm1cs_kv002_d8872958:
    ...
    kv "Es sind ein paar kostenlose Fotos! Außerdem wirst du verstehen, warum ich diesen Preis verlange, wenn du sie gesehen hast."
...
translate deutsch sm1cs_kv002_20a4d082:
    ...
    kv "Mach dir keine Sorgen. Das ist ein langjähriger Kunde von mir und... Es ist ein etwas ungewöhnliches Shooting. Aber du solltest mich bald anrufen!"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:268
translate deutsch sm1cs_kv002_412bb0e3:

    # mc "I will!"
    mc "Das werde ich!"

# game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:270
translate deutsch sm1cs_kv002_68a0b075:

    # kv "You better!"
    kv "Das solltest du auch!"
...
translate deutsch strings:
    ...
    new "Du musst dich bei denen doch langweilen"

    # game/code/scenes/character_scenes/kv/sm1cs-kv002.rpy:205
    old "Beats sitting in an office"
    new "Besser als im Büro zu sitzen"

...
translate deutsch sm1ms027_53fd5caa:
    ...
    sy "Ich brauchte dich wach, damit du mit mir den Startknopf drücken kannst!"

# game/code/scenes/main_story/sm1ms027.rpy:46
translate deutsch sm1ms027_7abf7341:

    # mc "You're so sweet to wait for me."
    mc "Du bist so süß, dass du auf mich wartest."
...
translate deutsch sm1ms027_91ec06d1:
    ...
    mc "Okay, okay. Mal sehen, was wir da haben."
...
translate deutsch sm1ms027_a5c7b785:
    ...
    "Stacy und [mcname]" "Drei... zwei... eins..."
...
translate deutsch sm1ms027_0741c7c8:
    ...
    mct "Ich bin mir nicht sicher, ob ich sie jemals so sehr geliebt habe wie jetzt gerade."

# game/code/scenes/main_story/sm1ms027.rpy:100
translate deutsch sm1ms027_510c69e3:

    # mc "Come here, you ridiculous genius."
    mc "Komm her, du lächerliches Genie."
...
translate deutsch sm1ms027_733aa482:
    ...
    sy "Die beste Launchparty aller Zeiten."
...
translate deutsch sm1ms027_5e740579:
    ...
    sy "Hey, nur damit du es weißt: Wenn du es dir noch einmal ansehen oder jemandem zeigen möchtest, kannst du diesen Laptop benutzen. Öffne einfach die Website, sie ist gleich dort."
...
translate deutsch sm1ms027_17d271c5:
    ...
    sy "Ich habe vergessen, die verdammten Speicherberechtigungen einzurichten! Der Film lässt sich nicht einmal abspielen!"
...
translate deutsch sm1ms027_b2458794:
    ...
    sy "Die Leute werden auf den Link klicken und er wird einfach ... nicht da sein!"
...
translate deutsch sm1ms027_6054e68b:
    ...
    sy "Es wird 404 erscheinen! Wie ein trauriger, toter Link mitten in der Nacht!"
...
translate deutsch sm1ms027_2ab0bbda:
    ...
    mc "Im Moment ist doch niemand wach, um es zu sehen, oder...?"
...
translate deutsch sm1ms027_1d921f90:
    ...
    sy "Es gibt immer geile Leute, die zu jeder Tageszeit nach heißen Sachen suchen, [mcname]!"
...
translate deutsch sm1ms027_5717c942:
    ...
    mct "Sie tippt, als hinge das Schicksal der Menschheit davon ab."
...
translate deutsch sm1ms027_9139af9f:
    ...
    mc "Guten Morgen... oder... ist es noch Nacht?"
...
translate deutsch sm1ms027_822736c1:
    ...
    sy "[mcname]! Der Start! Es lief fantastisch! Wir haben Traffic! Die Leute schauen es sich an! Kommentieren! Teilen! Ich kann nicht – ich kann nicht still sitzen!"
...
translate deutsch sm1ms027_65bfbd05:
    ...
    mc "Ja, das liegt wahrscheinlich daran, dass du so viel Red Mongoose in dir hast, dass sich deine DNA unwiderruflich verändert haben könnte."
...
translate deutsch sm1ms027_52bb9482:
    ...
    sy "Das reicht nicht! Ich meine, ganz klar, denn ich muss noch E-Mails beantworten, jemand möchte einen BTS-Blogbeitrag und es gibt einen Meme-Thread."
...
translate deutsch sm1ms027_67f83c2a:
    ...
    sy "Oh mein Gott, jemand hat ein Meme erstellt, als Taisia mich am Ende herumwirft."
...
translate deutsch sm1ms027_12e2c88e:
    ...
    mc "Vielleicht brauchst du ein Nickerchen? Oder schließe einfach deine Augen für etwa... zehn Sekunden?"
...
translate deutsch sm1ms027_ceef8163:
    ...
    mct "Sie läuft mit Koffein, Adrenalin und purer Liebe für dieses Projekt."
...
translate deutsch sm1ms027_7cec397c:
    ...
    sy "...CDN-Fallback-Caching... Bucket-Regeln... mm... alles mit gzip komprimieren..."
...
translate deutsch sm1ms027_ff232698:
    ...
    mc "Gute Nacht, mein sexy Code-Kobold. Du hast es dir verdient."
...
translate deutsch sm1ms027_88026827:
    ...
    mc "Nun, ich denke, ich sollte selbst ein wenig arbeiten."

translate deutsch strings:
    ...
    new "Hey Min. Was gibt's Neues?"

    # game/code/data/chat/chat_mes.rpy:3
    old "Classes, studying, sleep 😓"
    new "Unterricht, Lernen, Schlafen 😓"

    # game/code/data/chat/chat_mes.rpy:3
    old "Starting to wish I never came back here 😕"
    new "Ich fange an, mir zu wünschen, ich wäre nie wieder hierher zurückgekommen. 😕"

    # game/code/data/chat/chat_mes.rpy:3
    old "It's going to get better. I just know it."
    new "Es wird besser werden. Ich weiß es einfach."

    # game/code/data/chat/chat_mes.rpy:3
    old "How can I help you, [mcname!i]?"
    new "Wie kann ich dir helfen, [mcname!i]?"

    # game/code/data/chat/chat_mes.rpy:3
    old "I want to invite you to check out the studio 😊"
    new "Ich möchte dich einladen, dir das Studio anzusehen. 😊"

    # game/code/data/chat/chat_mes.rpy:3
    old "I would, but I should focus."
    new "Ich würde gerne, aber ich sollte mich konzentrieren."

    # game/code/data/chat/chat_mes.rpy:3
    old "Come on. You're working yourself too hard."
    new "Komm schon. Du arbeitest zu hart."
    ...
    new "Da hast du es. Vertrau mir. Du wirst diesen Ort lieben."

    # game/code/data/chat/chat_mes.rpy:58
    old "Hey. Want to go for a drink?"
    new "Hey. Lust auf einen Drink?"

    # game/code/data/chat/chat_mes.rpy:58
    old "It will be on me."
    new "Das geht auf meine Rechnung."

    # game/code/data/chat/chat_mes.rpy:58
    old "Sure. What's the occasion?"
    new "Klar. Was ist der Anlass?"

    # game/code/data/chat/chat_mes.rpy:58
    old "Nothing special. Call it a mind-break date 😇"
    new "Nichts Besonderes. Nennen wir es ein Date zum Abschalten. 😇"

    # game/code/data/chat/chat_mes.rpy:58
    old "Oh. I like the sound of that 😀"
    new "Oh. Das klingt gut. 😀"

    # game/code/data/chat/chat_mes.rpy:58
    old "Don't be strange. I didn't mean a \"date\" date."
    new "Sei nicht komisch. Ich meinte kein \"Date\" Date."

translate deutsch strings:
    ...
    new "Du wechselst jetzt in den VN-Modus\nDein Fortschritt wird übernommen\n\nDies wird nicht empfohlen, da dadurch Fehler und Störungen auftreten können."
    ...
    new "Sobald du gewechselt hast, kannst du nicht mehr zurückkehren\n\nDu kannst weiterhin deinen alten Spielstand laden, um normal weiterzuspielen."

    # game/code/renpy/labels/vn_mode.rpy:20
    old "It's recomended to start a new game in VN Mode\n\nPlease procced at your own risk"
    new "Es wird empfohlen, ein neues Spiel im VN-Modus zu starten\n\nBitte fahre auf eigene Gefahr fort."

    # game/code/renpy/labels/vn_mode.rpy:35
    old "You have finished all the content avialable in this release"
    new "Du hast alle in dieser Version verfügbaren Inhalte abgeschlossen."

    # game/code/renpy/labels/vn_mode.rpy:39
    old "Please save your game so you can resume playing from here in the next release"
    new "Bitte speicher dein Spiel, damit du es in der nächsten Version an dieser Stelle fortsetzen kannst."

translate portuguese strings:
    ...
    # game/code/renpy/screens/others.rpy:15
    old "Download Saves"
    new "Baixar Saves"

    # game/code/renpy/screens/others.rpy:60
    old "SKIP"
    new "PULAR"

    # game/code/renpy/screens/others.rpy:198
    old "Please enter your name here!"
    new "Por favor entre seu nome aqui!"
    ...
    new "Por favor insira seu IP local:"
    ...
    new "Coletamos apenas dados anonimizados para entender quais rotas, personagens, cenas e fetiches são mais populares e para identificar onde melhorar."

    # game/code/renpy/screens/others.rpy:8
    old "NO PERSONAL INFORMATION IS COLLECTED."
    new "NENHUMA INFOIRMAÇÃO PESSOAL É COLETADA."

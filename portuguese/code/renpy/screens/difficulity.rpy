...
translate portuguese strings:
    ...
    new "História completa com exploração e escolha de jogador"

    # game/code/renpy/screens/difficulity.rpy:54
    old "Sandbox-style free roaming"
    new "Mundo aberto estilo Sandbox"

    # game/code/renpy/screens/difficulity.rpy:54
    old "Minigames and quests"
    new "Minigames e quests"

    # game/code/renpy/screens/difficulity.rpy:54
    old "Character stats and progression"
    new "Atributos de personagem e progressão"

    # game/code/renpy/screens/difficulity.rpy:54
    old "Minigames are skipped or auto-resolved"
    new "Minigames são pulados ou solucionam automaticamente"

    # game/code/renpy/screens/difficulity.rpy:54
    old "Quests and character progression"
    new "Quests e progressão de personagens"

    # game/code/renpy/screens/difficulity.rpy:54
    old "Most of the story with player-driven progression"
    new "A maior parte da história com progressão feita pelo jogador"

    # game/code/renpy/screens/difficulity.rpy:54
    old "No free roaming or open exploration"
    new "Sem mundo aberto nem exploração"

    # game/code/renpy/screens/difficulity.rpy:54
    old "Minigames and sandbox activities removed"
    new "Atividades de Minigames e sandbox removidas"

    # game/code/renpy/screens/difficulity.rpy:54
    old "A streamlined experience focusing on narrative"
    new "Uma experiência enxuta focada na narrativa"

translate spanish strings:
    ...
    new "Ahora cambiarás al modo Novela Visual. \nTu progreso se mantendrá. Esto no es recomendable y puede provocar errores y fallos."
    ...
    new "Una vez que cambias, no puedes retroceder \nTodavía puedes cargar tu antiguo archivo de guardado para seguir jugando con normalidad."

    # game/code/renpy/labels/vn_mode.rpy:20
    old "It's recomended to start a new game in VN Mode\n\nPlease procced at your own risk"
    new "Se recomienda iniciar un nuevo juego en modo Novela Visual \nPor favor, proceda bajo su propia responsabilidad."

    # game/code/renpy/labels/vn_mode.rpy:35
    old "You have finished all the content avialable in this release"
    new "Has terminado todo el contenido disponible en esta versión"

    # game/code/renpy/labels/vn_mode.rpy:39
    old "Please save your game so you can resume playing from here in the next release"
    new "Por favor guarde su juego para que pueda reanudar el juego desde aquí en el próximo lanzamiento."

translate spanish strings:
    ...
    # game/code/classes/player.rpy:40
    old "You were charged {} for the rent"
    new "You were charged {} for the rent"

    # game/code/classes/player.rpy:65
    old "Do you want to skip time and sleep right now?"
    new "Do you want to skip time and sleep right now?"

    # game/code/classes/player.rpy:83
    old "You just got $"
    new "You just got $"

    # game/code/classes/player.rpy:254
    old "You just discovered new location on the map"
    new "You just discovered new location on the map"

    # game/code/classes/player.rpy:272

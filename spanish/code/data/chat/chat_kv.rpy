translate spanish strings:
    ...
    new "Pero el cliente quiere centrarse en el anal 🍑"
    ...
    new "Stacy podría estar en problemas, jajaja."

    # game/code/data/chat/chat_kv.rpy:3
    old "She'll be fine."
    new "Ella estará bien."

    # game/code/data/chat/chat_kv.rpy:3
    old "Not our first trip into the mud."
    new "No es nuestro primer viaje al barro."

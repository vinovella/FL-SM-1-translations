...
translate spanish q_inter_cw_1_42ce3580:
    ...
    cw "[mcname], ¿cómo te estás adaptando?"
...
translate spanish q_inter_cw_1_6d9f70f4:
    ...
    mc "Uh, ¿bien? Creo. Me llevo bien con casi todos."
...
translate spanish q_inter_cw_2_7ede8939:
    ...
    cw "Nuestro plazo está llegando, [mcname]. Será mejor que hagas tu parte del proyecto."
...
translate spanish q_inter_cw_2_cb24f6ff:
    ...
    mc "Uhhhh, ¡sí! No es necesario preocuparse por mí, Claire."
...
translate spanish q_inter_cw_2_9f34f997:
    ...
    mct "¡Mierda, debería regresar al trabajo!"
...
translate spanish q_inter_cw_3_1cb0d01c:
    ...
    cw "*En silencio* ¿Eso es realmente lo que pasa por moda esta temporada?"
...
translate spanish q_inter_cw_4_461998a0:
    ...
    cw "[mcname], ¿te gusta la comida de fusión rusa cubana?"
...
translate spanish q_inter_cw_4_5b4d2caa:
    ...
    cw "Fui a un nuevo restaurante anoche y no era tan aficionada. Tengo algunos cupones de descuento que te puedo dar si te gusta la fusión rusa cubana."
...
translate spanish q_inter_cw_4_7101a319:
    ...
    cw "Después de probar su comida, estás tomando la decisión correcta."
...
translate spanish q_inter_cw_6_d822c5bd:
    ...
    cw "Me voy por la puerta, ¿es urgente?"
...
translate spanish q_inter_cw_6_1f94f9a3:
    ...
    cw "Si aparece algo mientras estoy fuera, habla con Anna."
...
translate spanish q_inter_cw_7_3b1dcaa8:
    ...
    cw "[mcname], ¿cómo crees que el equipo de Anna está actuando?"
...
translate spanish q_inter_cw_7_77843274:
    ...
    mc "Creo que lo estamos haciendo bien."
...
translate spanish q_inter_cw_7_a233997e:
    ...
    cw "Bien. Necesito que todos brillen en las siguientes semanas."
...
translate spanish q_inter_cw_8_8a54e362:
    ...
    cw "Oh, sólo un chef ganador del premio Jimmy Beerd está en la ciudad, y quiero ir..."
...
translate spanish q_inter_cw_10_4f4d96e6:
    ...
    cw "Ese es uno de los sellos distintivos del marketing."

# game/code/data/quick_interactions/IT_office/q-inter-cw.rpy:142
translate spanish q_inter_cw_10_d494ddfb:
    ...
    cw "Promete un barco, pero un barco hecho de niebla para que cuando tengas que encontrar detalles, puedas averiguar de qué estaba hecho el barco."

# game/code/data/quick_interactions/IT_office/q-inter-cw.rpy:143
translate spanish q_inter_cw_10_7bf4c958:

    # cw "Right on the spot."
    cw "Justo en el lugar."

# game/code/data/quick_interactions/IT_office/q-inter-cw.rpy:147
translate spanish q_inter_cw_10_0e62f593:

    # cw "It might not even have been a ship at all."
    cw "Puede que ni siquiera haya sido un barco."

# game/code/data/quick_interactions/IT_office/q-inter-cw.rpy:149
translate spanish q_inter_cw_10_1f649e89:

    # mc "Uh... sure."
    mc "Uh... Claro."

# game/code/data/quick_interactions/IT_office/q-inter-cw.rpy:156
translate spanish q_inter_cw_11_21f87acc:

    # mc "*cutesy* Hey Honey. When is our next lunch?"
    mc "*bonito* Hola cariño. ¿Cuándo es nuestro próximo almuerzo?"

# game/code/data/quick_interactions/IT_office/q-inter-cw.rpy:159
translate spanish q_inter_cw_11_03020337:

    # cw "Go away. Now."
    cw "Vete. Ahora."

# game/code/data/quick_interactions/IT_office/q-inter-cw.rpy:86
translate spanish q_inter_cw_6_144c0d07:

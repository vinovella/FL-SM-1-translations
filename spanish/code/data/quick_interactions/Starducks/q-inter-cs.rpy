...
translate spanish q_inter_cs_1_77a255db:
    ...
    cs "Hola, bienvenidos a Starducks. Donde no quemamos a propósito los granos."
...
translate spanish q_inter_cs_1_eddc781a:
    ...
    cs "Quemamos los granos. A propósito."
...
translate spanish q_inter_cs_2_9dc09dcd:
    ...
    cs "Si desea pedir uno de los frappes, hoy no están disponibles."
...
translate spanish q_inter_cs_2_f26c52dc:
    ...
    cs "Sí, la máquina de frappe no funciona. Y sólo hay un técnico autorizado que pueda repararla. En el estado."
...
translate spanish q_inter_cs_3_5861dc26:
    ...
    cs "No. Solo voy a ir a casa y acurrucarme con mi gato."
...
translate spanish q_inter_cs_4_ddf4872d:
    ...
    cs "Tengo que recordar renunciar a mi membresía del gimnasio."
...
translate spanish q_inter_cs_4_5a0f525c:
    ...
    mc "Oh, ¿por qué renuncias al gimnasio?"
...
translate spanish q_inter_cs_4_8d5c7dfb:
    ...
    cs "Porque en este trabajo se toman muy en serio lo de 'poder levantar 20 kilogramos por encima de la cabeza'."
...
translate spanish q_inter_cs_4_75a5445c:
    ...
    cs "¿Por qué pagarle a alguien para hacer ejercicio, cuando me están {i}pagando{/i} para hacer ejercicio aquí?"
...
translate spanish q_inter_cs_5_894bd0f0:
    ...
    cs "Bienvenido a Starducks, hogar del café Starducks. ¿Puedo tomar su pedido?"

...
translate spanish q_inter_sj_1_a2fc8d5f:
    ...
    mc "Estaba pensando en algo que quería preguntarte. Si tienes un momento."
...
translate spanish q_inter_sj_1_54e6f5c0:
    ...
    mc "Me preguntaba si solías actuar en el escenario. ¿O si siempre has sido sólo una solucionadora para el grupo?"
...
translate spanish q_inter_sj_1_3c97550f:
    ...
    sj "Nada. Me Acabo de imaginar en el escenario. Denise probablemente lo perdería."
...
translate spanish q_inter_sj_1_42ac9700:
    ...
    sj "Ah, sí. Lo intenté cuando era más joven. Pero a día de hoy no puedo memorizar una línea o mantener una nota para salvar mi vida."
...
translate spanish q_inter_sj_1_470742b8:
    ...
    sj "Una vida en el escenario no es lo mío. Por supuesto, me sigue encantando el teatro, la presentación, toda la gente trabajando junta."
...
translate spanish q_inter_sj_1_c2eb1245:
    ...
    sj "Me encantaría trabajar en películas como productora algún día, administrando las cosas detrás de escena."
...
translate spanish q_inter_sj_1_8d2299be:
    ...
    sj "Así que por ahora, evito que las ruedas se caigan por aquí. Si te quedas aquí el tiempo suficiente, verás que para que un espectáculo funcione hace falta mucho más que gente en el escenario."
...
translate spanish q_inter_sj_2_ca1dc0cd:
    ...
    sj "Nada mal. Solo me tomo un pequeño respiro, luego tengo que regresar de nuevo."
...
translate spanish q_inter_sj_2_7eed0678:
    ...
    mc "Espero que Denise no te esté agobiando."
...
translate spanish q_inter_sj_2_456a8ea6:
    ...
    sj "Jah. Nada que no pueda manejar. Estuve en el equipo de atletismo durante la universidad. Me encanta correr cuando la situación lo requiere."
...
translate spanish q_inter_sj_2_fc7ae565:
    ...
    mc "¿Así que haces esto para ejercitarte?"
...
translate spanish q_inter_sj_2_e9f4af72:
    ...
    sj "Pequeño collum A, pequeño collum B. A veces un espectáculo tiene una emergencia y se necesita a alguien que pueda solucionar el problema en un santiamén."
...
translate spanish q_inter_sj_2_87074cb8:
    ...
    sj "Y ahí es donde entro yo. Hablando de eso, Bruce necesita un poco de pulido de escudo. Hasta luego, [mcname]."
...
translate spanish q_inter_sj_3_e5c43ab5:
    ...
    mc "¿Cuánto tiempo llevas haciendo esto, Sue?"
...
translate spanish q_inter_sj_3_f7089bbe:
    ...
    sj "Empecé a mitad de la carrera. Quería conseguir algo de dinero para pasear durante un verano y, cuando terminé, Denise me suplicó que me quedara."
...
translate spanish q_inter_sj_3_87252aa2:
    ...
    sj "O simplemente soy buena interpretando sus estados de ánimo. Tiene muchos."
...
translate spanish q_inter_sj_3_fb82c456:
    ...
    mc "¿Puedes decirme si está de mal humor? Podría evitar que me grite si me equivoco."
...
translate spanish q_inter_sj_3_22e59acc:
    ...
    sj "Jaja. Lo intentaré, pero a veces necesita desahogarse. No es nada personal. Pone mucho de sí misma en su oficio."
...
translate spanish q_inter_sj_3_8181169c:
    ...
    sj "Para nada. Si alguna vez termino trabajando en películas, estoy segura de que trataré con personas que hacen que Denise parezca un pequeño gatito suave."

...
translate spanish sm1fs_t006_8ba8c007:
    ...
    nr "Espero que incluya bratwurst o salchichas. Es todo lo que mi mente puede procesar hoy."
...
translate spanish sm1fs_t006_c47f7d80:
    ...
    mc "Bueno, supongo que de algún modo tiene que ver con salchichas."
...
translate spanish sm1fs_t006_ebeeaf7d:
    ...
    mc "¿Conoces el teatro en la calle Beeks?"
...
translate spanish sm1fs_t006_e43d8e34:
    ...
    nr "Sí. Vi {i}Hairspray{/i} y {i}Four Seasons{/i} hace un par de años."
...
translate spanish sm1fs_t006_439fffaa:
    ...
    nr "Siempre me divierte ver en qué andan los actores locales."
...
translate spanish sm1fs_t006_d01d39a6:
    ...
    mc "Qué bien. De hecho trabajo para la compañía que dirige el teatro."
...
translate spanish sm1fs_t006_16aa7f63:
    ...
    mc "La Directora está por anunciar una nueva obra."
...
translate spanish sm1fs_t006_6a011441:
    ...
    ms "Las obras son solo combustible para distraernos mientras las élites nos meten la mano en el bolsillo."
...
translate spanish sm1fs_t006_9941400c:
    ...
    ms "Son mucho peores. Cantan y bailan sobre agitar las aguas, pero ¿dónde está el musical que diga que hay que quemar todo el sistema podrido?"
...
translate spanish sm1fs_t006_bf40bd15:
    ...
    mc "Tendré que probarlas algún día. Pero como decía, Pizza World está patrocinando la nueva obra."

# game/code/scenes/theatre/sm1fs-t006.rpy:68
translate spanish sm1fs_t006_a0a16479:

    # mc "We're doing a riff on Romeo and Juliet."
    mc "Estamos haciendo una variación de Romeo y Julieta."
...
translate spanish sm1fs_t006_43d10c24:
    ...
    mc "En vez de dos familias rivales, pensamos en una historia de dos restaurantes rivales."

# game/code/scenes/theatre/sm1fs-t006.rpy:72
translate spanish sm1fs_t006_4c0f49e3:

    # nr "Hey. That's pretty clever."
    nr "Oye, eso es bastante ingenioso."
...
translate spanish sm1fs_t006_12f1cd68:
    ...
    mc "Gracias. Y ya que tenemos un restaurante, quería ver si te gustaría patrocinar la obra."
...
translate spanish sm1fs_t006_1ee0b36c:
    ...
    ms "Te lo dije. Manos en los bolsillos."

# game/code/scenes/theatre/sm1fs-t006.rpy:89
translate spanish sm1fs_t006_1ee0b36c:

    # ms "Told you. Hands in wallets."
    ms "Te lo dije. Con las manos en nuestras billeteras."
...
translate spanish sm1fs_t006_3fc71820:
    ...
    nr "Déjame ver si entiendo. Quieres hacer una historia de dos amantes destinados al fracaso, que termina en tragedia."
...
translate spanish sm1fs_t006_a265e2b7:
    ...
    nr "Un personaje es de Pizza World y el otro sería de Wurst Delivery."
...
translate spanish sm1fs_t006_76c0c16c:
    ...
    mc "Sí, esa era la idea, Nelson. Pensé que sería una buena forma de atraer más clientela."

# game/code/scenes/theatre/sm1fs-t006.rpy:99
translate spanish sm1fs_t006_f71758e1:

    # nr "Drum up business? We're doing just fine."
    nr "¿Impulsar el negocio? Estamos muy bien así."
...
translate spanish sm1fs_t006_db6da2bf:
    ...
    nr "Bien, [mcname]. Puede que tengas algo entre manos."
...
translate spanish sm1fs_t006_8c452a7e:
    ...
    nr "Bueno, diste en el clavo. Definitivamente necesitaría hablar con esa Directora tuya."
...
translate spanish sm1fs_t006_363c974e:
    ...
    nr "Parece que están ajustando un poco el guion, pero quiero asegurarme de que nadie muere en la obra por trabajar o comer en Wurst Delivery."
...
translate spanish sm1fs_t006_c9ed38f3:
    ...
    mc "Por supuesto. No creo que eso fuera a ser un problema de todos modos."
...
translate spanish sm1fs_t006_2b7e539c:
    ...
    ms "Wurst Delivery también va a necesitar una fila completa de asientos para cada función. Gratis."

# game/code/scenes/theatre/sm1fs-t006.rpy:139
translate spanish sm1fs_t006_1e961481:

    # mc "When did you?"
    mc "¿Cuándo dijiste eso?"
...
translate spanish sm1fs_t006_33fd6dd2:
    ...
    ms "Si Nelson va a invertir dinero en esta obra tuya, debería recibir algo más que la simple esperanza de que llegue más gente al local."
...
translate spanish sm1fs_t006_3bf76577:
    ...
    mc "Vaya con la mente para los negocios que tiene Maya."
...
translate spanish sm1fs_t006_9d9f2492:
    ...
    nr "Espera. Todo este tiempo dijiste que odiabas el teatro."
...
translate spanish sm1fs_t006_07c15933:
    ...
    ms "Es importante no dejar que los problemas personales se interpongan con los buenos negocios. Eso lo aprendí de todos esos imbéciles que vuelan en jets privados."
...
translate spanish sm1fs_t006_771f0d7a:
    ...
    ms "Si conseguimos esos asientos, podemos rifarlos entre los clientes que compren un pedido de veinte dólares o más."

# game/code/scenes/theatre/sm1fs-t006.rpy:153
translate spanish sm1fs_t006_f36c6a72:

    # ms "It will be win-win, Nelson."
    ms "Será un ganar-ganar, Nelson."
...
translate spanish sm1fs_t006_8285e50b:
    ...
    nr "Supongo. No quiero presionar demasiado a la señorita Denise."
...
translate spanish sm1fs_t006_57255a01:
    ...
    mc "Estoy seguro de que Denise puede perder una sección de asientos sin arruinarse."
...
translate spanish sm1fs_t006_0ae6a4d5:
    ...
    ms "Sí que lo hará, si quiere que Wurst Delivery patrocine la obra."
...
translate spanish sm1fs_t006_9e2a08a6:
    ...
    mc "Puede que tengamos que juntar ideas y pensar en otros negocios, Maya."

# game/code/scenes/theatre/sm1fs-t006.rpy:170
translate spanish sm1fs_t006_4c225523:

    # mc "You seem pretty good at this."
    mc "Parece que eres bastante buena en esto."
...
translate spanish sm1fs_t006_06d3f97b:
    ...
    ms "Ventajas de todas esas clases que tomé y que me dejaron con una deuda estudiantil horrible."
...
translate spanish sm1fs_t006_72cd54cc:
    ...
    ms "Y sí, quizá podamos pensar juntos otro día."
...
translate spanish sm1fs_t006_a45399dd:
    ...
    ms "Pero por ahora, deberías concentrarte en conseguir este patrocinio."
...
translate spanish sm1fs_t006_87633129:
    ...
    ms "Ja. No estoy involucrada, solo estoy ayudando a Nelson."
...
translate spanish sm1fs_t006_274a5a7c:
    ...
    ms "Y si me da un diez por ciento de las ganancias de los combos, entonces todos contentos."
...
translate spanish sm1fs_t006_754d5b0c:
    ...
    mc "Bien, me pondré en marcha y le informaré a Denise."
...
translate spanish sm1fs_t006_9dbedbc6:
    ...
    mc "Gracias por escucharme, Nelson. Creo que este patrocinio saldrá muy bien."
...
translate spanish strings:
    ...
    new "Deberíamos hablar de negocios otra vez algún día"

    # game/code/scenes/theatre/sm1fs-t006.rpy:165
    old "Strange how involved you got"
    new "Curioso lo mucho que te involucraste"

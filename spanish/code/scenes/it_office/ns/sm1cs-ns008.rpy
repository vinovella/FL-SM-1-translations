...
translate spanish sm1cs_ns008_c08aaaec:
    ...
    mct "Muy bien, las cosas están tranquilas. El momento perfecto para saludar a Nari."
...
translate spanish sm1cs_ns008_ca3e4960:
    ...
    mct "Es extraño, me imaginaba que vendría a hablarme de nuestra cita. Normalmente es tan entusiasta."
...
translate spanish sm1cs_ns008_d5b5e956:
    ...
    mct "Probablemente debería dejarla sola por ahora. Parece que está realmente concentrada en su tarea."
...
translate spanish sm1cs_ns008_0779b06a:
    ...
    mct "Me pregunto qué está pasando con ella."
...
translate spanish sm1cs_ns008_e01df6f6:
    ...
    mct "Todavía no me ha hablado de por qué tuvo que irse tan rápido esa noche que estuvimos juntos..."
...
translate spanish sm1cs_ns008_63167b95:
    ...
    cw "Atentos, División C.U.M. Necesito a Peter, Eugene, Anna, Abril, Jayden, Nari y [mcname]."

# game/code/scenes/it_office/ns/sm1cs-ns008.rpy:41
translate spanish sm1cs_ns008_ee6f587f:

    # cw "Conference room in five minutes."
    cw "Sala de conferencias en cinco minutos."
...
translate spanish sm1cs_ns008_ccd5078d:
    ...
    mct "Excelente. Otra reunión. Nari ama las reuniones."
...
translate spanish sm1cs_ns008_2647e5d5:
    ...
    mct "Tal vez esto la saque de su depresión."
...
translate spanish sm1cs_ns008_1227ec18:
    ...
    mc "Nari. Claire nos necesita en la sala de conferencias."
...
translate spanish sm1cs_ns008_425d808a:
    ...
    ns "¿Sabías que la palabra \"conferencia\" procede del latín medieval conferentia, que significa \"contribución, discusión\"?"
...
translate spanish sm1cs_ns008_c32effee:
    ...
    mc "¿Te sientes bien, Nari? ¿Quieres hablar de eso?"
...
translate spanish sm1cs_ns008_9e891e49:
    ...
    ns "Todo está bien. Mejor que bien."
...
translate spanish sm1cs_ns008_4f75cdc7:
    ...
    ns "No le digas a nadie, pero ahora tengo novio."
...
translate spanish sm1cs_ns008_14f313ab:
    ...
    ns "Sí. Es divertido y solidario. Y él también es realmente pervertido. Y trabajamos juntos."
...
translate spanish sm1cs_ns008_d277549c:
    ...
    mct "Muy bien, es bueno verla de regreso a su yo habitual."
...
translate spanish sm1cs_ns008_86336d29:
    ...
    cw "Tenemos un nuevo problema para nuestro proyecto del sitio web del Canal Seis."
...
translate spanish sm1cs_ns008_411b7848:
    ...
    am "¿Qué ahora? Ya estamos tratando de eliminar el maldito virus."
...
translate spanish sm1cs_ns008_d4701337:
    ...
    cw "Afortunadamente, no se trata del virus, pero espero que uno de ustedes tenga una solución para eso pronto."
...
translate spanish sm1cs_ns008_deac0df6:
    ...
    am "Bueno, no puedo ser yo. La codificación va como la seda."
...
translate spanish sm1cs_ns008_5c4653ba:
    ...
    am "Y a pesar de su discapacidad, [mcname] ha estado ayudando mucho."
...
translate spanish sm1cs_ns008_77b7e877:
    ...
    cw "Eso es lo que me gusta escuchar, [mcname]."
...
translate spanish sm1cs_ns008_aedc1427:
    ...
    mc "Bien. No te decepcionaré, Claire."
...
translate spanish sm1cs_ns008_b0e8d577:
    ...
    cw "Pero no, el código no es el problema que debemos revisar."
...
translate spanish sm1cs_ns008_fb684216:
    ...
    cw "El problema es un troll que siempre se mete con la antigua web del Canal Seis. La que estamos reemplazando."
...
translate spanish sm1cs_ns008_7b6c5b39:
    ...
    en "Jaja. ¿Piensan que tienen un troll? Solo yo he visto trolls reales."
...
translate spanish sm1cs_ns008_2130a7f1:
    ...
    en "En el viejo continente, los trolls lo estropean todo."
...
translate spanish sm1cs_ns008_f3e160af:
    ...
    en "Un año, mi padre no vendió un nabo entero porque un troll malvado le dijo a la gente que los nabos de mi padre les dejarían estériles."

# game/code/scenes/it_office/ns/sm1cs-ns008.rpy:145
translate spanish sm1cs_ns008_83364f7f:

    # en "He was nearly ruined..."
    en "Estaba casi arruinado..."
...
translate spanish sm1cs_ns008_84191c22:
    ...
    cw "Bueno, este bromista va a ser tan malo como el que arruinó el negocio de tu padre, Eugene."
...
translate spanish sm1cs_ns008_1d342a5f:
    ...
    cw "Han sido una espina clavada en el costado del Canal Seis durante años, y al parecer, se han enterado de que estamos trabajando en un nuevo sitio web."
...
translate spanish sm1cs_ns008_3acd3b46:
    ...
    cw "Angela me llamó hoy y me advirtió que el Troll ahora ha atacado al nuevo sitio web."

# game/code/scenes/it_office/ns/sm1cs-ns008.rpy:156
translate spanish sm1cs_ns008_72a29c14:

    # pm "This cannot stand."
    pm "Esto no puede seguir así."
...
translate spanish sm1cs_ns008_05d0f3b2:
    ...
    pm "Tenemos que golpear primero. No necesitamos que un imbécil arruine nuestro nuevo proyecto."
...
translate spanish sm1cs_ns008_a5c95cdf:
    ...
    ag "Bueno, algunos de estos disruptores online han sido agentes de cambio recientemente. Quizá esta persona solo intenta llamar la atención sobre los errores cometidos por el estudio de noticias."
...
translate spanish sm1cs_ns008_1c484dcb:
    ...
    cw "No los traje a todos para discutir los méritos de los trolls en línea."
...
translate spanish sm1cs_ns008_230eb9f1:
    ...
    cw "*suspira* ¿Sí, Abril? ¿También tienes una opinión sobre los trolls?"
...
translate spanish sm1cs_ns008_417d54be:
    ...
    am "No. El único troll por el que deberían preocuparse es el que trabaja aquí."
...
translate spanish sm1cs_ns008_15e0eb02:
    ...
    cw "No importa cuál sea la agenda de esta persona. Angela quiere nuevas medidas de protección en su lugar."
...
translate spanish sm1cs_ns008_483443dd:
    ...
    am "Podría crear un programa que doxxe el Asshat una vez que publique en el nuevo sitio web."

# game/code/scenes/it_office/ns/sm1cs-ns008.rpy:200
translate spanish sm1cs_ns008_a7212e2e:

    # cw "No. No more doxxing."
    cw "No. No más doxxing."
...
translate spanish sm1cs_ns008_fef84e2d:
    ...
    en "No. Lo siento, Claire. Todavía estoy pensando en mi pobre papá."
...
translate spanish sm1cs_ns008_f8883351:
    ...
    mc "*susurros* Vamos. Dile a Claire tu idea."
...
translate spanish sm1cs_ns008_4e4b39d7:
    ...
    ns "*susurros* No puedo. ¿Y si ella se enoja? ¿Y si ella lo odia?"
...
translate spanish sm1cs_ns008_50d2af66:
    ...
    mc "*susurra* Es una de tus ideas. Estoy seguro de que es increíble."
...
translate spanish sm1cs_ns008_90db8033:
    ...
    mc "*susurros* Tienes esto, Nari. Sé que lo tienes."
...
translate spanish sm1cs_ns008_dcc86111:
    ...
    ns "Puedo crear un programa que actuará como un monitor para el nuevo sitio web."
...
translate spanish sm1cs_ns008_f708f754:
    ...
    ns "Estoy segura de que la Sra. Porillo puede proporcionarnos algunas de las publicaciones anteriores del alborotador."
...
translate spanish sm1cs_ns008_e5c7dcc4:
    ...
    ns "Tomaré esos mensajes antiguos y le enseñaré al programa qué buscar para asegurarnos de que este usuario no sea un problema para nuestro nuevo sitio web."
...
translate spanish sm1cs_ns008_ae5c87b4:
    ...
    ns "Incluso puedo agregar algún software de seguimiento, por lo que una vez que se detecta un problema del usuario, podemos localizar su dirección IP."
...
translate spanish sm1cs_ns008_ce00d8c1:
    ...
    cw "Yo también me estoy haciendo fan. ¿Cuánto tiempo le llevaría, Srta. Song?"
...
translate spanish sm1cs_ns008_e11a3226:
    ...
    ns "Probablemente alrededor de una semana. Yo...{w} Tendría que quedarme aquí hasta tarde la mayoría de los días, si le parece bien, Srta. Watts."
...
translate spanish sm1cs_ns008_a8d800ad:
    ...
    cw "Claro, eso ayudaría a asegurarse de que aún pueda pasar tiempo en los servidores de video."
...
translate spanish sm1cs_ns008_3a0dc24c:
    ...
    ns "Sí. Eso es exactamente lo que estaba pensando."
...
translate spanish sm1cs_ns008_d53d14ef:
    ...
    cw "Muy bien, plan aprobado. Gracias, Nari, si puedes poner ese programa en acción, el cliente estará muy contento con nosotros."

# game/code/scenes/it_office/ns/sm1cs-ns008.rpy:269
translate spanish sm1cs_ns008_2740d83e:

    # ns "Uh... happy to help."
    ns "Uh... feliz de ayudar."
...
translate spanish sm1cs_ns008_2ba13af9:
    ...
    cw "Muy bien a todos, volvamos a eso."
...
translate spanish sm1cs_ns008_599d7e86:
    ...
    mc "Así se hace, Nari. Sabía que funcionaría."
...
translate spanish sm1cs_ns008_4ab13f1b:
    ...
    ns "Pero tendrá que esperar. Quiero decir, me encantaría pasar el rato contigo esta noche, pero debería comenzar el programa."
...
translate spanish sm1cs_ns008_338c147e:
    ...
    ns "¿Y te parece bien esperar un poco hasta nuestra próxima cita?"

...
translate spanish strings:
    ...
    new "Usar el primer ángulo"

    # game/code/scenes/main_story/sm1ms023.rpy:81
    old "Use the second angle"
    new "Usar el segundo ángulo"

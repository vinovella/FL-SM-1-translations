...
translate spanish sm1mv01s05i_2f292d45:

    # mc "Hey Stacy. All set to film the 'Recruitment' scene?"
    mc "Hola, Stacy. ¿Todo listo para grabar la escena de 'Reclutamiento'?"

# game/code/scenes/movies/movie01/sm1mv01s05i.rpy:10
translate spanish sm1mv01s05i_cf513cd9:

    # sy "Yup. I'm super excited."
    sy "Sí. Estoy superemocionada."

# game/code/scenes/movies/movie01/sm1mv01s05i.rpy:11
translate spanish sm1mv01s05i_8bd5057c:

    # sy "The set looks so good."
    sy "El set se ve muy bien."

# game/code/scenes/movies/movie01/sm1mv01s05i.rpy:15
translate spanish sm1mv01s05i_82dbfc3c:

    # sy "*sighs* Feels like it took months to get to this point."
    sy "*suspira* Parece que tardamos meses en llegar a este punto."

# game/code/scenes/movies/movie01/sm1mv01s05i.rpy:17
translate spanish sm1mv01s05i_c0d24858:

    # mc "Haha. Well, now we're finally ready."
    mc "Jaja. Bueno, ahora finalmente estamos listos."

# game/code/scenes/movies/movie01/sm1mv01s05i.rpy:21
translate spanish sm1mv01s05i_94baf1a9:
